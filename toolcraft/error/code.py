...
class RaiseExplicitly(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(msgs=["Error while coding !!!", *msgs])
...
class ShouldNeverHappen(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(msgs=["This should never happen !!!", *msgs])
...
class CodingError(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(msgs=["Possible error/bug while coding !!!", *msgs])
...
class ImplementInChildClass(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(
            msgs=["Please implement this in child class !!!", *msgs])
...
class NotSupported(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(msgs=["We do not support this!!!", *msgs])
...
class ExitGracefully(_CustomException):
    ...
    def __init__(self, *, msgs: MESSAGES_TYPE):
        super().__init__(msgs=["Exiting Gracefully !!!", *msgs])
