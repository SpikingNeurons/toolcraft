            ...
            with dpg.table_row():
                for j in range(columns):
                    dpg.add_checkbox(label=names[i * columns + j],
                                     ...
                                     default_value=
                                     dpg.get_item_configuration(item)[
                                         names[i * columns + j]])
        dpg.pop_container_stack()


def _add_config_option(item, default_value, *names):
    dpg.add_radio_button(names, default_value=default_value, callback=_config,
                         user_data=item)
...
def show_demo():
    ...
    with dpg.window(label="Dear PyGui Demo", width=800, height=800,
        ...
        with dpg.menu_bar():
            ...
            with dpg.menu(label="Menu"):
                ...
                with dpg.menu(label="Settings"):
                    ...
                    dpg.add_menu_item(label="Option 2", check=True,
                                      callback=_log)
                    dpg.add_menu_item(label="Option 3", check=True,
                                      default_value=True, callback=_log)
            ...
            with dpg.menu(label="Tools"):
                ...
                dpg.add_menu_item(label="Show Style Editor",
                                  callback=lambda: dpg.show_tool(
                                      dpg.mvTool_Style))
                dpg.add_menu_item(label="Show Font Manager",
                                  callback=lambda: dpg.show_tool(
                                      dpg.mvTool_Font))
            ...
            with dpg.menu(label="Settings"):
                dpg.add_menu_item(label="Wait For Input", check=True,
                                  callback=lambda s, a: dpg.configure_app(
                                      wait_for_input=a))
        ...
        with dpg.group(horizontal=True):
            ...
            with dpg.group():
                dpg.add_text(
                    f'Dear PyGui says hello. ({dpg.get_dearpygui_version()})')
                with dpg.group(horizontal=True):
                    dpg.add_text(
        ...
        with dpg.collapsing_header(label="Widgets"):
            ...
            with dpg.tree_node(label="Basic"):
                        ...
                        with dpg.theme(tag="__demo_theme" + str(i)):
                            with dpg.theme_component(dpg.mvButton):
                                dpg.add_theme_color(dpg.mvThemeCol_Button,
                                                    _hsv_to_rgb(i / 7.0, 0.6,
                                                                0.6))
                                dpg.add_theme_color(dpg.mvThemeCol_ButtonActive,
                                                    _hsv_to_rgb(i / 7.0, 0.8,
                                                                0.8))
                                dpg.add_theme_color(
                                    dpg.mvThemeCol_ButtonHovered,
                                    _hsv_to_rgb(i / 7.0, 0.7, 0.7))
                                dpg.add_theme_style(
                                    dpg.mvStyleVar_FrameRounding, i * 5)
                ...
                with dpg.group(horizontal=True):
                    ...
                    dpg.add_button(arrow=True, direction=dpg.mvDir_Left,
                                   user_data=widget,
                                   callback=lambda s, a, u: dpg.set_value(u,
                                                                          int(dpg.get_value(
                                                                              u)) - 1))
                ...
                dpg.add_combo(("AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF",
                              ...
                              label="combo", default_value="AAAA",
                              callback=_log)
                dpg.add_input_text(label="input text",
                                   default_value="Hello, world!", callback=_log)
                _help(
                    "USER:\n"
                ...
                dpg.add_input_text(label="input text (w/ hint)",
                                   hint="enter text here", callback=_log)
                dpg.add_input_int(label="input int", callback=_log)
                dpg.add_input_float(label="input float", callback=_log,
                                    format="%.06f")
                dpg.add_input_float(label="input float scientific", format="%e",
                                    callback=_log)
                dpg.add_input_floatx(label="input floatx", callback=_log,
                                     default_value=[1, 2, 3, 4])
                dpg.add_input_double(label="input double", callback=_log,
                                     format="%.14f")
                dpg.add_input_doublex(label="input doublex", callback=_log,
                                      default_value=[1, 2, 3, 4],
                                      format="%.14f")
                ...
                dpg.add_drag_float(label="drag small float",
                                   default_value=0.0067, format="%.06f ns",
                                   callback=_log)
                ...
                dpg.add_slider_double(label="slider double", max_value=1.0,
                                      format="ratio = %.14f", callback=_log)
                dpg.add_slider_int(label="slider angle", min_value=-360,
                                   max_value=360, format="%d deg",
                                   callback=_log)
                _help(
                ...
                dpg.add_color_edit(default_value=(.5, 1, .25, .1),
                                   label="color edit 4", callback=_log)
                dpg.add_listbox(("Apple", "Banana", "Cherry", "Kiwi", "Mango",
                                 "Orange", "Pineapple", "Strawberry",
                                 "Watermelon"), label="listbox", num_items=4,
                                callback=_log)
            ...
            with dpg.tree_node(label="Combo"):
                ...
                _add_config_options(combo_id, 1, "popup_align_left",
                                    "no_arrow_button", "no_preview")
            ...
            with dpg.tree_node(label="Color Picker & Edit"):
                ...
                with dpg.group(horizontal=True):
                    ...
                    dpg.add_radio_button(("mvColorEdit_AlphaPreviewNone",
                                         ...
                                         callback=_color_picker_configs,
                                         user_data=_color_picker_id,
                                         horizontal=True)

                with dpg.group(horizontal=True):
                    dpg.add_text("display_type:")
                    dpg.add_radio_button(
                        ("mvColorEdit_uint8", "mvColorEdit_float"),
                        callback=_color_picker_configs,
                        user_data=_color_picker_id, horizontal=True)
                ...
                with dpg.group(horizontal=True):
                    ...
                    dpg.add_radio_button(("mvColorEdit_rgb", "mvColorEdit_hsv",
                                          "mvColorEdit_hex"),
                                         callback=_color_picker_configs,
                                         user_data=_color_edit_id,
                                         horizontal=True)
                ...
                _add_config_options(_color_edit_id, 3,
                                    "no_alpha", "no_picker",
                                    "no_options", "no_inputs",
                                    "no_small_preview",
                                    "no_tooltip", "no_label",
                                    "no_drag_drop", "alpha_bar",
                                    before=_before_id)

            with dpg.tree_node(label="Colormaps"):
                dpg.add_text("Notes")
                dpg.add_text("Colormaps belong to a mvColorMapRegistry.",
                ...
                dpg.add_text(
                    ...
                    bullet=True, indent=20)
                dpg.add_text(
                    "Colormaps can be sampled with 'sample_colormap(colormap_id, t)' (0<t<1)",
                    bullet=True, indent=20)
                dpg.add_text(
                ...
                dpg.add_colormap([[0, 0, 0, 255], [255, 255, 255, 255]], False,
                                 ...
                                 parent="__demo_colormap_registry",
                                 label="Demo 1")
                ...
                dpg.add_colormap_slider(label="Colormap Slider 1",
                                        default_value=0.5)
                dpg.bind_colormap(dpg.last_item(), "__demo_colormap_1")
                ...
                with dpg.group(horizontal=True):
                    ...
                    dpg.bind_colormap(dpg.last_item(), "__demo_colormap_2")
                    dpg.add_colormap_scale(label="Colormap Spectral",
                                           min_scale=-100, max_scale=150)
            ...
            with dpg.tree_node(label="List Boxes"):
                ...
                dpg.add_input_int(label="num_items", callback=_config,
                                  user_data=[listbox_1, listbox_2],
                                  before=listbox_1)
                dpg.add_slider_int(label="width", default_value=200,
                                   callback=_config, user_data=listbox_2,
            ...
            with dpg.tree_node(label="Selectables"):
                ...
                with dpg.tree_node(label="Selection State: Single"):
                    ...
                    for item in items:
                        dpg.configure_item(item, callback=_selection,
                                           user_data=items)
            ...
            with dpg.tree_node(label="Text"):
                ...
                with dpg.tree_node(label="Word Wrapping"):
                    ...
                    widget_id = dpg.add_slider_int(label="wrap width",
                                                   default_value=500,
                                                   max_value=1000,
                                                   callback=lambda s, a,
                                                                   u: dpg.configure_item(
                                                       u, wrap=a))
            ...
            with dpg.tree_node(label="Text Input"):
                ...
                with dpg.tree_node(label="Filtered Text Input"):
                    ...
                    dpg.add_input_text(callback=_log, label="decimal",
                                       decimal=True)
                    dpg.add_input_text(callback=_log, label="no blank",
                                       no_spaces=True)
                    dpg.add_input_text(callback=_log, label="uppercase",
                                       uppercase=True)
            ...
            with dpg.tree_node(label="Simple Plots"):
                ...
                dpg.add_simple_plot(label="Histogram", default_value=data,
                                    height=80, histogram=True, min_scale=0.0)

                data1 = []
                for i in range(70):
                    data1.append(cos(3.14 * 6 * i / 180))

                dpg.add_simple_plot(label="Lines", default_value=data1,
                                    height=80)
                dpg.add_simple_plot(label="Histogram", default_value=data1,
                                    height=80, histogram=True)
                with dpg.group(horizontal=True):
                    dpg.add_progress_bar(label="Progress Bar",
                                         default_value=0.78, overlay="78%")
                ...
                for i in range(2, 5):
                    with dpg.group():
                        float_source = dpg.add_input_floatx(
                            label=f"input float {i}", min_value=0.0,
                            max_value=100.0, size=i)
                        dpg.add_drag_floatx(label=f"drag float {i}",
                                            source=float_source, size=i)
                        dpg.add_slider_floatx(label=f"slider float {i}",
                                              source=float_source, size=i)

                    with dpg.group():
                        double_source = dpg.add_input_doublex(
                            label=f"input double {i}", min_value=0.0,
                            max_value=100.0, size=i)
                        dpg.add_drag_doublex(label=f"drag double {i}",
                                             source=double_source, size=i)
                        dpg.add_slider_doublex(label=f"slider double {i}",
                                               source=double_source, size=i)

                    with dpg.group():
                        int_source = dpg.add_input_intx(label=f"input int {i}",
                                                        min_value=0,
                                                        max_value=100, size=i)
                        dpg.add_drag_intx(label=f"drag int {i}",
                                          source=int_source, size=i)
            ...
            with dpg.tree_node(label="Vertical Sliders"):
                ...
                with dpg.group(horizontal=True):
                    dpg.add_slider_int(label=" ", default_value=1,
                                       vertical=True, max_value=5, height=160)
                    dpg.add_slider_double(label=" ", default_value=1.0,
                                          vertical=True, max_value=5.0,
                                          height=160)
        ...
        with dpg.collapsing_header(label="Layout & Scrolling"):
            ...
            with dpg.tree_node(label="Absolute Position Placement"):
                dpg.add_button(label="Set Button 2 Pos",
                               callback=lambda: dpg.set_item_pos(B2, (50, 125)))
                dpg.add_button(label="Reset Button 2 Pos",
                               callback=lambda: dpg.reset_pos(B2))
                dpg.add_button(label="Button 1", pos=[50, 50], width=75,
                               height=75)
            ...
            with dpg.tree_node(label="Grid Layout using Table API"):
                ...
                dpg.add_text(
                    "Tables can be used to layout items in an equally spaced grid pattern.")
                dpg.add_text("See tables section for more detail on tables.")
                dpg.add_checkbox(label="resizable", callback=_config,
                                 user_data=layout_demo_table)
                dpg.add_checkbox(label="borders_innerH", callback=_config,
                                 user_data=layout_demo_table,
                                 default_value=True)
                dpg.add_checkbox(label="borders_outerH", callback=_config,
                                 user_data=layout_demo_table,
                                 default_value=True)
                dpg.add_checkbox(label="borders_innerV", callback=_config,
                                 user_data=layout_demo_table,
                                 default_value=True)
            ...
            with dpg.tree_node(label="Containers"):
                ...
                with dpg.tree_node(label="Tree Nodes"):
                    with dpg.tree_node(label="Tree Node (selectable)",
                                       selectable=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
                ...
                with dpg.tree_node(label="Groups"):
                    dpg.add_text(
                        "Groups are used to control child items placement, width, and provide a hit box for things like is the set of items are hovered, ect...")
                    with dpg.group(horizontal=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
                ...
                with dpg.tree_node(label="Child windows"):
                    ...
                    dpg.add_text(
                        "Child windows are basically embedded windows and provide much more structure and control of the containing items than groups.")
                    with dpg.group(horizontal=True):
                        dpg.add_checkbox(label="autosize_x", callback=_config,
                                         user_data=demo_layout_child)
                        dpg.add_checkbox(label="autosize_y", callback=_config,
                                         user_data=demo_layout_child)
                        dpg.add_checkbox(label="menubar", callback=_config,
                                         user_data=demo_layout_child)
                        dpg.add_checkbox(label="no_scrollbar", callback=_config,
                                         user_data=demo_layout_child)
                        dpg.add_checkbox(label="horizontal_scrollbar",
                                         callback=_config,
                                         user_data=demo_layout_child)
                        dpg.add_checkbox(label="border", default_value=True,
                                         callback=_config,
                                         user_data=demo_layout_child)
                    with dpg.child_window(tag=demo_layout_child, width=200,
                                          height=200):
                        with dpg.menu_bar():
                            with dpg.menu(label="Menu"):
                                pass
                    ...
                    with dpg.child_window(autosize_x=True, height=130,
                                          menubar=True):
                        with dpg.menu_bar():
                ...
                with dpg.tree_node(label="Collapsing Headers"):
                    ...
                    with dpg.collapsing_header(
                        label="Collapsing Header (close)", closable=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
                    with dpg.collapsing_header(
                        label="Collapsing Header (bullet)", bullet=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
                    with dpg.collapsing_header(label="Collapsing Header (leaf)",
                                               leaf=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
            ...
            with dpg.tree_node(label="Simple Layouts"):
                ...
                with dpg.child_window(width=500, height=320):
                    ...
                    with dpg.child_window(autosize_x=True, height=95):
                        with dpg.group(horizontal=True):
                            dpg.add_button(label="Header 1", width=75,
                                           height=75)
                            dpg.add_button(label="Header 2", width=75,
                                           height=75)
                            dpg.add_button(label="Header 3", width=75,
                                           height=75)
            ...
            with dpg.tree_node(label="Scrolling"):
                ...
                def _scroll_programmatically(sender, app_data, user_data):
                    ...
                    with dpg.mutex():
                        ...
                        if user_data[
                            0] == "right" and x_scroll < max_scroll - 10:
                            dpg.set_x_scroll(user_data[1], x_scroll + 10)
        ...
        with dpg.collapsing_header(label="Textures & Images"):
            ...
            with dpg.tree_node(label="Help"):
                ...
                dpg.add_text("Textures are buffers of RGBA data.", bullet=True,
                             indent=20)
                ...
                dpg.add_text("Textures are themselves widgets.", bullet=True,
                             indent=20)
                dpg.add_text(
                ...
                dpg.add_text(
                    ...
                    bullet=True, indent=20)
                dpg.add_text(
                    "The texture container widget is hidden by default.",
                    bullet=True, indent=20)
                with dpg.group(horizontal=True):
                    dpg.add_text(
            ...
            with dpg.tree_node(label="Static Textures"):
                ...
                dpg.add_text("Can NOT be modified after creation.", bullet=True,
                             indent=20)
                dpg.add_text(
                    "Can be loaded from a file using the 'file' keyword.",
                    bullet=True, indent=20)
                dpg.add_separator()
                ...
                with dpg.group(horizontal=True):
                    ...
                    with dpg.group():
                        ...
                        dpg.add_image("__demo_static_texture_3", width=200,
                                      height=200)
            ...
            with dpg.tree_node(label="Dynamic Textures"):
                ...
                with dpg.group(horizontal=True):
                    with dpg.group():
                        dpg.add_color_picker((255, 0, 255, 255),
                                             label="Texture 1",
                                             no_side_preview=True,
                                             alpha_bar=True, width=200,
                                             callback=_update_dynamic_textures,
                                             user_data=1)
                        dpg.add_text("Image Button")
                        dpg.add_image_button("__demo_dynamic_texture_1",
                                             width=100, height=100)

                    with dpg.group():
                        dpg.add_color_picker((255, 255, 0, 255),
                                             label="Texture 2",
                                             no_side_preview=True,
                                             alpha_bar=True, width=200,
                                             callback=_update_dynamic_textures,
            ...
            with dpg.tree_node(label="Drawlists"):
                with dpg.drawlist(width=400, height=300):
                    dpg.draw_rectangle((0, 0), (400, 300),
                                       color=(100, 100, 100, 250), thickness=2)
                    dpg.draw_image("__demo_static_texture_3", [0, 0],
                                   [100, 100])
                    dpg.draw_image("__demo_dynamic_texture_1", [200, 100],
                                   [300, 200])
        ...
        with dpg.collapsing_header(label="Popups & Modal Windows"):
            ...
            with dpg.tree_node(label="Popups"):
                ...
                popup_values = ["Bream", "Haddock", "Mackerel", "Pollock",
                                "Tilefish"]
                ...
                with dpg.group(horizontal=True):
                    ...
                    with dpg.popup(b, tag="__demo_popup1"):
                        ...
                        for i in popup_values:
                            dpg.add_selectable(label=i, user_data=[t, i],
                                               callback=lambda s, a,
                                                               u: dpg.set_value(
                                                   u[0], u[1]))
            ...
            with dpg.tree_node(label="File/Directory Selector"):
                ...
                dpg.add_button(label="Show File Selector",
                               ...
                               callback=lambda s, a, u: dpg.configure_item(u,
                                                                           show=True))
        ...
        with dpg.collapsing_header(label="Tables"):
            ...
            with dpg.tree_node(label="Borders, background") as section:
                ...
                _add_config_options(table_id, 2,
                                    ...
                                    "borders_innerV",
                                    "borders_outerH", "borders_outerV",
                                    "header_row", before=table_id)
            ...
            with dpg.tree_node(label="Colors"):
                ...
                _add_config_options(table_id, 1, "row_background",
                                    before=table_id)
                ...
                with dpg.table(header_row=False, row_background=True,
                    ...
                    for i in range(6):
                        dpg.set_table_row_color(table_id, i,
                                                [255, 0, 0, i * 255 / 8])
            ...
            with dpg.tree_node(label="Resizable, stretch"):
                ...
                _add_config_options(table_id, 1,
                                    "borders_innerV", "borders_outerV",
                                    "resizable", before=table_id)
            ...
            with dpg.tree_node(label="Resizable, fixed"):
                ...
                with dpg.table(header_row=False,
                               ...
                               borders_outerV=True,
                               borders_outerH=True) as table_id:
                ...
                _add_config_options(table_id, 1, "no_host_extendX",
                                    before=table_id)
            ...
            with dpg.tree_node(label="Resizable, mixed"):
                ...
                with dpg.table(header_row=True,
                               ...
                               hideable=True,
                               borders_innerV=True, delay_search=True,
                               borders_outerV=True, borders_innerH=True,
                               borders_outerH=True):
            ...
            with dpg.tree_node(label="Row height"):
                ...
                with dpg.table(header_row=False, borders_outerH=True,
                               borders_outerV=True, delay_search=True):
                    dpg.add_table_column()
            ...
            with dpg.tree_node(label="Padding"):
                ...
                with dpg.table(header_row=False, resizable=True,
                               ...
                               hideable=True, reorderable=True,
                               borders_outerV=True,
                               borders_innerH=True) as table_id:
                    ...
                    for i in range(5):
                        with dpg.table_row():
                            for j in range(3):
                                dpg.add_button(label=f"Hello {i}, {j}",
                                               width=-1)

                _add_config_options(table_id, 3,
                                    "pad_outerX", "no_pad_outerX",
                                    "no_pad_innerX",
                                    "borders_outerV", "borders_innerV",
                                    "header_row", before=table_id)
            ...
            with dpg.tree_node(label="Outer Size"):
                ...
                _add_config_options(table_id, 3,
                                    "no_host_extendX", "no_host_extendY",
                                    "resizable", before=table_id)
            ...
            with dpg.tree_node(label="Scrolling, Clipping"):
                ...
                dpg.add_checkbox(label="resizable", before=table_id,
                                 default_value=True, user_data=table_id,
                                 callback=lambda sender, app_data,
                                                 user_data: dpg.configure_item(
                                     user_data, resizable=app_data))
                ...
                with dpg.table(header_row=True, borders_innerH=True,
                               borders_outerH=True, borders_innerV=True,
                               borders_outerV=True, row_background=True,
                               height=300, freeze_rows=1, freeze_columns=1,
            ...
            with dpg.tree_node(label="Sorting"):
                ...
                def _sort_callback(sender, sort_specs):
                    ...
                    sortable_list.sort(key=_sorter,
                ...
                dpg.add_checkbox(label="sort_tristate",
                                 before="__demo_sorting_table",
                                 callback=lambda sender, app_data,
                                                 user_data: dpg.configure_item(
                                     "__demo_sorting_table",
            ...
            with dpg.tree_node(label="Sizing Policy"):
                ...
                def callback(sender, value, user_data):
                    ...
                    if user_data[8] == "resizable":
                        ...
                        for i in range(8):
                            dpg.configure_item(user_data[i],
                                               no_host_extendX=value)

                    elif user_data[8] == "policy":

                        if value == "mvTable_SizingFixedFit":
                            dpg.configure_item(user_data[user_data[9]],
                                               policy=dpg.mvTable_SizingFixedFit)
                            dpg.configure_item(user_data[user_data[9] + 1],
                                               policy=dpg.mvTable_SizingFixedFit)
                ...
                def create_table_set(policy):
                    ...
                    with dpg.table(header_row=False, policy=policy,
                                   ...
                                   borders_innerV=True,
                                   borders_outerV=True,
                                   row_background=True) as table_id1:
                    ...
                    with dpg.table(header_row=False, policy=policy,
                                   ...
                                   borders_outerV=True,
                                   row_background=True) as table_id2:
                ...
                user_data = [table_id1, table_id12, table_id2, table_id22,
                             table_id3, table_id32, table_id4, table_id42]

                sizing_options = (
                "mvTable_SizingFixedFit", "mvTable_SizingFixedSame",
                "mvTable_SizingStretchProp", "mvTable_SizingStretchSame")

                combo1 = dpg.add_combo(sizing_options, label="Sizing Policy",
                                       default_value=sizing_options[0],
                                       before=table_id1,
                                       user_data=user_data + ["policy", 0],
                                       callback=callback)
                dpg.add_combo(sizing_options, label="Sizing Policy",
                              default_value=sizing_options[1], before=table_id2,
                              user_data=user_data + ["policy", 2],
                              callback=callback)
                dpg.add_combo(sizing_options, label="Sizing Policy",
                              default_value=sizing_options[2], before=table_id3,
                              user_data=user_data + ["policy", 4],
                              callback=callback)
                dpg.add_combo(sizing_options, label="Sizing Policy",
                              default_value=sizing_options[3], before=table_id4,
                              user_data=user_data + ["policy", 6],
                              callback=callback)
                dpg.add_checkbox(label="resizable", before=combo1,
                                 user_data=user_data + ["resizable"],
                                 callback=callback)
                dpg.add_checkbox(label="no_host_extendX", before=combo1,
                                 user_data=user_data + ["no_host_extendX"],
                                 callback=callback)
            ...
            with dpg.tab_bar():
                ...
                with dpg.tab(label="Series"):
                    ...
                    with dpg.tree_node(label="Line Series"):
                        dpg.add_text(
                            "Anti-aliasing can be enabled from the plot's context menu (see Help).",
                            bullet=True)
                    ...
                    with dpg.tree_node(label="Infinite Lines"):
                        ...
                        with dpg.plot(label="Infinite Lines", height=400,
                            ...
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            with dpg.plot_axis(dpg.mvYAxis, label="y"):
                                dpg.add_vline_series(infinite_x_data,
                                                     label="vertical")
                    ...
                    with dpg.tree_node(label="Candle Stick Series"):
                        dates = [1546300800, 1546387200, 1546473600, 1546560000,
                                 1546819200, 1546905600, 1546992000, 1547078400,
                                 1547164800, 1547424000, 1547510400, 1547596800,
                                 1547683200, 1547769600, 1547942400, 1548028800,
                                 1548115200, 1548201600, 1548288000, 1548374400,
                                 1548633600, 1548720000, 1548806400, 1548892800,
                                 1548979200, 1549238400, 1549324800, 1549411200,
                                 1549497600, 1549584000, 1549843200, 1549929600,
                                 1550016000, 1550102400, 1550188800, 1550361600,
                                 1550448000, 1550534400, 1550620800, 1550707200,
                                 1550793600, 1551052800, 1551139200, 1551225600,
                                 1551312000, 1551398400, 1551657600, 1551744000,
                                 1551830400, 1551916800, 1552003200, 1552262400,
                                 1552348800, 1552435200, 1552521600, 1552608000,
                                 1552867200, 1552953600, 1553040000, 1553126400,
                                 1553212800, 1553472000, 1553558400, 1553644800,
                                 1553731200, 1553817600, 1554076800, 1554163200,
                                 1554249600, 1554336000, 1554422400, 1554681600,
                                 1554768000, 1554854400, 1554940800, 1555027200,
                                 1555286400, 1555372800, 1555459200, 1555545600,
                                 1555632000, 1555891200, 1555977600, 1556064000,
                                 1556150400, 1556236800, 1556496000, 1556582400,
                                 1556668800, 1556755200, 1556841600, 1557100800,
                                 1557187200, 1557273600, 1557360000, 1557446400,
                                 1557705600, 1557792000, 1557878400, 1557964800,
                                 1558051200, 1558310400, 1558396800, 1558483200,
                                 1558569600, 1558656000, 1558828800, 1558915200,
                                 1559001600, 1559088000, 1559174400, 1559260800,
                                 1559520000, 1559606400, 1559692800, 1559779200,
                                 1559865600, 1560124800, 1560211200, 1560297600,
                                 1560384000, 1560470400, 1560729600, 1560816000,
                                 1560902400, 1560988800, 1561075200, 1561334400,
                                 1561420800, 1561507200, 1561593600, 1561680000,
                                 1561939200, 1562025600, 1562112000, 1562198400,
                                 1562284800, 1562544000, 1562630400, 1562716800,
                                 1562803200, 1562889600, 1563148800, 1563235200,
                                 1563321600, 1563408000, 1563494400, 1563753600,
                                 1563840000, 1563926400, 1564012800, 1564099200,
                                 1564358400, 1564444800, 1564531200, 1564617600,
                                 1564704000, 1564963200, 1565049600, 1565136000,
                                 1565222400, 1565308800, 1565568000, 1565654400,
                                 1565740800, 1565827200, 1565913600, 1566172800,
                                 1566259200, 1566345600, 1566432000, 1566518400,
                                 1566777600, 1566864000, 1566950400, 1567036800,
                                 1567123200, 1567296000, 1567382400, 1567468800,
                                 1567555200, 1567641600, 1567728000, 1567987200,
                                 1568073600, 1568160000, 1568246400, 1568332800,
                                 1568592000, 1568678400, 1568764800, 1568851200,
                                 1568937600, 1569196800, 1569283200, 1569369600,
                                 1569456000, 1569542400, 1569801600, 1569888000,
                                 1569974400, 1570060800, 1570147200, 1570406400,
                                 1570492800, 1570579200, 1570665600, 1570752000,
                                 1571011200, 1571097600, 1571184000, 1571270400,
                                 1571356800, 1571616000, 1571702400, 1571788800,
                                 1571875200, 1571961600]
                        opens = [1284.7, 1319.9, 1318.7, 1328, 1317.6, 1321.6,
                                 1314.3, 1325, 1319.3, 1323.1, 1324.7, 1321.3,
                                 1323.5, 1322, 1281.3, 1281.95, 1311.1, 1315,
                                 1314, 1313.1, 1331.9, 1334.2, 1341.3, 1350.6,
                                 1349.8, 1346.4, 1343.4, 1344.9, 1335.6, 1337.9,
                                 1342.5, 1337, 1338.6, 1337, 1340.4, 1324.65,
                                 1324.35, 1349.5, 1371.3, 1367.9, 1351.3,
                                 1357.8, 1356.1, 1356, 1347.6, 1339.1, 1320.6,
                                 1311.8, 1314, 1312.4, 1312.3, 1323.5, 1319.1,
                                 1327.2, 1332.1, 1320.3, 1323.1, 1328, 1330.9,
                                 1338, 1333, 1335.3, 1345.2, 1341.1, 1332.5,
                                 1314, 1314.4, 1310.7, 1314, 1313.1, 1315,
                                 1313.7, 1320, 1326.5, 1329.2, 1314.2, 1312.3,
                                 1309.5, 1297.4, 1293.7, 1277.9, 1295.8, 1295.2,
                                 1290.3, 1294.2, 1298, 1306.4, 1299.8, 1302.3,
                                 1297, 1289.6, 1302, 1300.7, 1303.5, 1300.5,
                                 1303.2, 1306, 1318.7, 1315, 1314.5, 1304.1,
                                 1294.7, 1293.7, 1291.2, 1290.2, 1300.4, 1284.2,
                                 1284.25, 1301.8, 1295.9, 1296.2, 1304.4,
                                 1323.1, 1340.9, 1341, 1348, 1351.4, 1351.4,
                                 1343.5, 1342.3, 1349, 1357.6, 1357.1, 1354.7,
                                 1361.4, 1375.2, 1403.5, 1414.7, 1433.2, 1438,
                                 1423.6, 1424.4, 1418, 1399.5, 1435.5, 1421.25,
                                 1434.1, 1412.4, 1409.8, 1412.2, 1433.4, 1418.4,
                                 1429, 1428.8, 1420.6, 1441, 1460.4, 1441.7,
                                 1438.4, 1431, 1439.3, 1427.4, 1431.9, 1439.5,
                                 1443.7, 1425.6, 1457.5, 1451.2, 1481.1, 1486.7,
                                 1512.1, 1515.9, 1509.2, 1522.3, 1513, 1526.6,
                                 1533.9, 1523, 1506.3, 1518.4, 1512.4, 1508.8,
                                 1545.4, 1537.3, 1551.8, 1549.4, 1536.9,
                                 1535.25, 1537.95, 1535.2, 1556, 1561.4, 1525.6,
                                 1516.4, 1507, 1493.9, 1504.9, 1506.5, 1513.1,
                                 1506.5, 1509.7, 1502, 1506.8, 1521.5, 1529.8,
                                 1539.8, 1510.9, 1511.8, 1501.7, 1478, 1485.4,
                                 1505.6, 1511.6, 1518.6, 1498.7, 1510.9, 1510.8,
                                 1498.3, 1492, 1497.7, 1484.8, 1494.2, 1495.6,
                                 1495.6, 1487.5, 1491.1, 1495.1, 1506.4]
                        highs = [1284.75, 1320.6, 1327, 1330.8, 1326.8, 1321.6,
                                 1326, 1328, 1325.8, 1327.1, 1326, 1326, 1323.5,
                                 1322.1, 1282.7, 1282.95, 1315.8, 1316.3, 1314,
                                 1333.2, 1334.7, 1341.7, 1353.2, 1354.6, 1352.2,
                                 1346.4, 1345.7, 1344.9, 1340.7, 1344.2, 1342.7,
                                 1342.1, 1345.2, 1342, 1350, 1324.95, 1330.75,
                                 1369.6, 1374.3, 1368.4, 1359.8, 1359, 1357,
                                 1356, 1353.4, 1340.6, 1322.3, 1314.1, 1316.1,
                                 1312.9, 1325.7, 1323.5, 1326.3, 1336, 1332.1,
                                 1330.1, 1330.4, 1334.7, 1341.1, 1344.2, 1338.8,
                                 1348.4, 1345.6, 1342.8, 1334.7, 1322.3, 1319.3,
                                 1314.7, 1316.6, 1316.4, 1315, 1325.4, 1328.3,
                                 1332.2, 1329.2, 1316.9, 1312.3, 1309.5, 1299.6,
                                 1296.9, 1277.9, 1299.5, 1296.2, 1298.4, 1302.5,
                                 1308.7, 1306.4, 1305.9, 1307, 1297.2, 1301.7,
                                 1305, 1305.3, 1310.2, 1307, 1308, 1319.8,
                                 1321.7, 1318.7, 1316.2, 1305.9, 1295.8, 1293.8,
                                 1293.7, 1304.2, 1302, 1285.15, 1286.85, 1304,
                                 1302, 1305.2, 1323, 1344.1, 1345.2, 1360.1,
                                 1355.3, 1363.8, 1353, 1344.7, 1353.6, 1358,
                                 1373.6, 1358.2, 1369.6, 1377.6, 1408.9, 1425.5,
                                 1435.9, 1453.7, 1438, 1426, 1439.1, 1418, 1435,
                                 1452.6, 1426.65, 1437.5, 1421.5, 1414.1,
                                 1433.3, 1441.3, 1431.4, 1433.9, 1432.4, 1440.8,
                                 1462.3, 1467, 1443.5, 1444, 1442.9, 1447,
                                 1437.6, 1440.8, 1445.7, 1447.8, 1458.2, 1461.9,
                                 1481.8, 1486.8, 1522.7, 1521.3, 1521.1, 1531.5,
                                 1546.1, 1534.9, 1537.7, 1538.6, 1523.6, 1518.8,
                                 1518.4, 1514.6, 1540.3, 1565, 1554.5, 1556.6,
                                 1559.8, 1541.9, 1542.9, 1540.05, 1558.9,
                                 1566.2, 1561.9, 1536.2, 1523.8, 1509.1, 1506.2,
                                 1532.2, 1516.6, 1519.7, 1515, 1519.5, 1512.1,
                                 1524.5, 1534.4, 1543.3, 1543.3, 1542.8, 1519.5,
                                 1507.2, 1493.5, 1511.4, 1525.8, 1522.2, 1518.8,
                                 1515.3, 1518, 1522.3, 1508, 1501.5, 1503,
                                 1495.5, 1501.1, 1497.9, 1498.7, 1492.1, 1499.4,
                                 1506.9, 1520.9]
                        lows = [1282.85, 1315, 1318.7, 1309.6, 1317.6, 1312.9,
                                1312.4, 1319.1, 1319, 1321, 1318.1, 1321.3,
                                1319.9, 1312, 1280.5, 1276.15, 1308, 1309.9,
                                1308.5, 1312.3, 1329.3, 1333.1, 1340.2, 1347,
                                1345.9, 1338, 1340.8, 1335, 1332, 1337.9, 1333,
                                1336.8, 1333.2, 1329.9, 1340.4, 1323.85,
                                1324.05, 1349, 1366.3, 1351.2, 1349.1, 1352.4,
                                1350.7, 1344.3, 1338.9, 1316.3, 1308.4, 1306.9,
                                1309.6, 1306.7, 1312.3, 1315.4, 1319, 1327.2,
                                1317.2, 1320, 1323, 1328, 1323, 1327.8, 1331.7,
                                1335.3, 1336.6, 1331.8, 1311.4, 1310, 1309.5,
                                1308, 1310.6, 1302.8, 1306.6, 1313.7, 1320,
                                1322.8, 1311, 1312.1, 1303.6, 1293.9, 1293.5,
                                1291, 1277.9, 1294.1, 1286, 1289.1, 1293.5,
                                1296.9, 1298, 1299.6, 1292.9, 1285.1, 1288.5,
                                1296.3, 1297.2, 1298.4, 1298.6, 1302, 1300.3,
                                1312, 1310.8, 1301.9, 1292, 1291.1, 1286.3,
                                1289.2, 1289.9, 1297.4, 1283.65, 1283.25,
                                1292.9, 1295.9, 1290.8, 1304.2, 1322.7, 1336.1,
                                1341, 1343.5, 1345.8, 1340.3, 1335.1, 1341.5,
                                1347.6, 1352.8, 1348.2, 1353.7, 1356.5, 1373.3,
                                1398, 1414.7, 1427, 1416.4, 1412.7, 1420.1,
                                1396.4, 1398.8, 1426.6, 1412.85, 1400.7, 1406,
                                1399.8, 1404.4, 1415.5, 1417.2, 1421.9, 1415,
                                1413.7, 1428.1, 1434, 1435.7, 1427.5, 1429.4,
                                1423.9, 1425.6, 1427.5, 1434.8, 1422.3, 1412.1,
                                1442.5, 1448.8, 1468.2, 1484.3, 1501.6, 1506.2,
                                1498.6, 1488.9, 1504.5, 1518.3, 1513.9, 1503.3,
                                1503, 1506.5, 1502.1, 1503, 1534.8, 1535.3,
                                1541.4, 1528.6, 1525.6, 1535.25, 1528.15, 1528,
                                1542.6, 1514.3, 1510.7, 1505.5, 1492.1, 1492.9,
                                1496.8, 1493.1, 1503.4, 1500.9, 1490.7, 1496.3,
                                1505.3, 1505.3, 1517.9, 1507.4, 1507.1, 1493.3,
                                1470.5, 1465, 1480.5, 1501.7, 1501.4, 1493.3,
                                1492.1, 1505.1, 1495.7, 1478, 1487.1, 1480.8,
                                1480.6, 1487, 1488.3, 1484.8, 1484, 1490.7,
                                1490.4, 1503.1]
                        closes = [1283.35, 1315.3, 1326.1, 1317.4, 1321.5,
                                  1317.4, 1323.5, 1319.2, 1321.3, 1323.3,
                                  1319.7, 1325.1, 1323.6, 1313.8, 1282.05,
                                  1279.05, 1314.2, 1315.2, 1310.8, 1329.1,
                                  1334.5, 1340.2, 1340.5, 1350, 1347.1, 1344.3,
                                  1344.6, 1339.7, 1339.4, 1343.7, 1337, 1338.9,
                                  1340.1, 1338.7, 1346.8, 1324.25, 1329.55,
                                  1369.6, 1372.5, 1352.4, 1357.6, 1354.2,
                                  1353.4, 1346, 1341, 1323.8, 1311.9, 1309.1,
                                  1312.2, 1310.7, 1324.3, 1315.7, 1322.4,
                                  1333.8, 1319.4, 1327.1, 1325.8, 1330.9,
                                  1325.8, 1331.6, 1336.5, 1346.7, 1339.2,
                                  1334.7, 1313.3, 1316.5, 1312.4, 1313.4,
                                  1313.3, 1312.2, 1313.7, 1319.9, 1326.3,
                                  1331.9, 1311.3, 1313.4, 1309.4, 1295.2,
                                  1294.7, 1294.1, 1277.9, 1295.8, 1291.2,
                                  1297.4, 1297.7, 1306.8, 1299.4, 1303.6,
                                  1302.2, 1289.9, 1299.2, 1301.8, 1303.6,
                                  1299.5, 1303.2, 1305.3, 1319.5, 1313.6,
                                  1315.1, 1303.5, 1293, 1294.6, 1290.4, 1291.4,
                                  1302.7, 1301, 1284.15, 1284.95, 1294.3,
                                  1297.9, 1304.1, 1322.6, 1339.3, 1340.1,
                                  1344.9, 1354, 1357.4, 1340.7, 1342.7, 1348.2,
                                  1355.1, 1355.9, 1354.2, 1362.1, 1360.1,
                                  1408.3, 1411.2, 1429.5, 1430.1, 1426.8,
                                  1423.4, 1425.1, 1400.8, 1419.8, 1432.9,
                                  1423.55, 1412.1, 1412.2, 1412.8, 1424.9,
                                  1419.3, 1424.8, 1426.1, 1423.6, 1435.9,
                                  1440.8, 1439.4, 1439.7, 1434.5, 1436.5,
                                  1427.5, 1432.2, 1433.3, 1441.8, 1437.8,
                                  1432.4, 1457.5, 1476.5, 1484.2, 1519.6,
                                  1509.5, 1508.5, 1517.2, 1514.1, 1527.8,
                                  1531.2, 1523.6, 1511.6, 1515.7, 1515.7,
                                  1508.5, 1537.6, 1537.2, 1551.8, 1549.1,
                                  1536.9, 1529.4, 1538.05, 1535.15, 1555.9,
                                  1560.4, 1525.5, 1515.5, 1511.1, 1499.2,
                                  1503.2, 1507.4, 1499.5, 1511.5, 1513.4,
                                  1515.8, 1506.2, 1515.1, 1531.5, 1540.2,
                                  1512.3, 1515.2, 1506.4, 1472.9, 1489, 1507.9,
                                  1513.8, 1512.9, 1504.4, 1503.9, 1512.8,
                                  1500.9, 1488.7, 1497.6, 1483.5, 1494, 1498.3,
                                  1494.1, 1488.1, 1487.5, 1495.7, 1504.7,
                                  1505.3]
                        ...
                        with dpg.plot(label="Candle Series", height=400,
                            ...
                            with dpg.plot_axis(dpg.mvYAxis, label="USD"):
                                dpg.add_candle_series(dates, opens, closes,
                                                      lows, highs,
                                                      label="GOOGL",
                    ...
                    with dpg.tree_node(label="Heatmaps"):
                        ...
                        with dpg.group(horizontal=True):
                            dpg.add_colormap_scale(min_scale=0, max_scale=6,
                                                   height=400)
                            with dpg.plot(label="Heat Series",
                                          no_mouse_pos=True, height=400,
                                          width=-1):
                                dpg.add_plot_axis(dpg.mvXAxis, label="x",
                    ...
                    with dpg.tree_node(label="Pie Charts"):
                        with dpg.group(horizontal=True):
                            # create plot 1
                            with dpg.plot(no_title=True, no_mouse_pos=True,
                    ...
                    with dpg.tree_node(label="Error Series"):
                        ...
                        with dpg.plot(label="Error Series", height=400,
                            ...
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            with dpg.plot_axis(dpg.mvYAxis, label="y"):
                                dpg.add_bar_series(error1_x, error1_y,
                                                   label="Bar", weight=0.25)
                                dpg.add_error_series(error1_x, error1_y,
                                                     error1_neg, error1_pos,
                                                     label="Bar")
                                dpg.add_line_series(error2_x, error2_y,
                                                    label="Line")
                                dpg.add_error_series(error2_x, error2_y,
                                                     error2_neg, error2_pos,
                                                     label="Line")
                                dpg.fit_axis_data(dpg.top_container_stack())
                            dpg.fit_axis_data(xaxis)
                ...
                with dpg.tab(label="Subplots"):
                    ...
                    with dpg.tree_node(label="Item Sharing"):
                        ...
                        with dpg.subplots(2, 3, label="", width=-1,
                    ...
                    with dpg.tree_node(label="Linked Axes"):
                        ...
                        with dpg.subplots(2, 2, label="", width=-1,
                                          height=-1) as subplot_id:
                            dpg.add_plot_legend()
                ...
                with dpg.tab(label="Axes"):
                    ...
                    with dpg.tree_node(label="Time Axes"):
                        ...
                        dpg.add_text(
                            "When time is enabled, x-axis values are interpreted as UNIX timestamps in seconds (e.g. 1599243545).",
                            bullet=True)
                        dpg.add_text(
                            "UNIX timestamps are seconds since 00:00:00 UTC on 1 January 1970",
                            bullet=True)
                        ...
                        with dpg.plot(label="Time Plot", height=400, width=-1):
                            ...
                            with dpg.plot_axis(dpg.mvYAxis,
                                ...
                                dpg.add_line_series(timedatax, timedatay,
                                                    label="Days")
                                dpg.fit_axis_data(dpg.top_container_stack())
                            dpg.fit_axis_data(xaxis)
                ...
                with dpg.tab(label="Tools"):
                    ...
                    with dpg.tree_node(label="Querying"):
                        ...
                        def query(sender, app_data, user_data):
                            dpg.set_axis_limits(user_data[0], app_data[0],
                                                app_data[1])
                            dpg.set_axis_limits(user_data[1], app_data[2],
                                                app_data[3])

                        # plot 1
                        with dpg.plot(no_title=True, height=400, callback=query,
                                      query=True, no_menus=True,
                                      width=-1) as plot_id:
                            dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            with dpg.plot_axis(dpg.mvYAxis, label="y"):
                                dpg.add_line_series(sindatax, sindatay)
                    ...
                    with dpg.tree_node(label="Drag Lines/Points"):
                        with dpg.plot(label="Drag Lines/Points", height=400,
                            ...
                            dpg.add_drag_line(label="dline1",
                                              color=[255, 0, 0, 255])
                            dpg.add_drag_line(label="dline2",
                                              color=[255, 255, 0, 255],
                                              vertical=False)
                            dpg.add_drag_point(label="dpoint1",
                                               color=[255, 0, 255, 255])
                            dpg.add_drag_point(label="dpoint2",
                                               color=[255, 0, 255, 255])
                    ...
                    with dpg.tree_node(label="Annotations"):
                        with dpg.plot(label="Annotations", height=400,
                            ...
                            dpg.add_plot_annotation(label="BL",
                                                    default_value=(0.25, 0.25),
                                                    offset=(-15, 15),
                                                    color=[255, 255, 0, 255])
                            dpg.add_plot_annotation(label="BR",
                                                    default_value=(0.75, 0.25),
                                                    offset=(15, 15),
                                                    color=[255, 255, 0, 255])
                            dpg.add_plot_annotation(label="TR not clampled",
                                                    default_value=(0.75, 0.75),
                                                    offset=(-15, -15),
                                                    color=[255, 255, 0, 255],
                                                    clamped=False)
                            dpg.add_plot_annotation(label="TL",
                                                    default_value=(0.25, 0.75),
                                                    offset=(-15, -15),
                                                    color=[255, 255, 0, 255])
                            dpg.add_plot_annotation(label="Center",
                    ...
                    with dpg.tree_node(label="Drag & Drop"):
                        ...
                        with dpg.group(horizontal=True):
                            ...
                            def _legend_drop(sender, app_data, user_data):
                                ...
                                yaxis2 = \
                                dpg.get_item_info(parent)["children"][1][2]
                            ...
                            def _plot_drop(sender, app_data, user_data):
                                yaxis1 = \
                                dpg.get_item_info(sender)["children"][1][0]
                                dpg.add_line_series(app_data[0], app_data[1],
                                                    label=app_data[2],
                                                    parent=yaxis1)
                                dpg.add_button(label="Delete Series",
                            ...
                            with dpg.plot(label="Drag/Drop Plot", height=400,
                                          width=-1, drop_callback=_plot_drop,
                                          payload_type="plotting"):
                ...
                with dpg.tab(label="Custom"):
                    ...
                    with dpg.tree_node(label="Custom Context Menus"):
                        ...
                        dpg.add_text("Right-click the series in the legend.",
                                     bullet=True)
                        dpg.add_text(
                            "Series are containers. Children will show up in the custom context menu.",
                            bullet=True)
                    ...
                    with dpg.tree_node(label="Custom Rendering"):
                        ...
                        # create plot
                        with dpg.plot(label="Custom Rendering", height=400,
                                      width=-1):
                            dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            dpg.add_plot_axis(dpg.mvYAxis, label="y")
                    ...
                    with dpg.tree_node(label="Custom Series"):
                        ...
                        def _custom_series_callback(sender, app_data):
                            ...
                            mouse_x_plot_space = _helper_data[
                                "MouseX_PlotSpace"]
                            mouse_y_plot_space = _helper_data[
                                "MouseY_PlotSpace"]
                            mouse_x_pixel_space = _helper_data[
                                "MouseX_PixelSpace"]
                            mouse_y_pixel_space = _helper_data[
                                "MouseY_PixelSpace"]
                            dpg.delete_item(sender, children_only=True, slot=2)
                            dpg.push_container_stack(sender)
                            dpg.configure_item("demo_custom_series",
                                               tooltip=False)
                            for i in range(0, len(transformed_x)):
                                dpg.draw_text((transformed_x[i] + 15,
                                               transformed_y[i] - 15), str(i),
                                              size=20)
                                dpg.draw_circle(
                                    (transformed_x[i], transformed_y[i]), 15,
                                    fill=(50 + i * 5, 50 + i * 50, 0, 255))
                                if mouse_x_pixel_space < transformed_x[
                                    i] + 15 and mouse_x_pixel_space > \
                                    transformed_x[
                                        i] - 15 and mouse_y_pixel_space > \
                                    transformed_y[
                                        i] - 15 and mouse_y_pixel_space < \
                                    transformed_y[i] + 15:
                                    dpg.draw_circle(
                                    ...
                                    dpg.configure_item("demo_custom_series",
                                                       tooltip=True)
                                    dpg.set_value("demo_custom_series_text",
                                                  "Current Point: " + str(i))
                            dpg.pop_container_stack()

                        # create plot
                        dpg.add_text("Hover an item for a custom tooltip!")
                        with dpg.plot(label="Custom Series", height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            ...
                            with dpg.plot_axis(dpg.mvYAxis):
                                with dpg.custom_series(
                                    [0.0, 1.0, 2.0, 4.0, 5.0],
                                    [0.0, 10.0, 20.0, 40.0, 50.0], 2,
                                    label="Custom Series",
                                    callback=_custom_series_callback,
                                    tag="demo_custom_series"):
                                    dpg.add_text("Current Point: ",
                                                 tag="demo_custom_series_text")
                                dpg.fit_axis_data(dpg.top_container_stack())
                ...
                with dpg.tab(label="Help"):
                    ...
                    dpg.add_text(
                        ...
                        bullet=True, indent=20)
                    dpg.add_text(
                        "Scoll in the plot area to zoom both X and Y axes.",
                        bullet=True)
                    dpg.add_text(
                        "Scroll on an axis to zoom an individual axis.",
                        bullet=True, indent=20)
                    dpg.add_text("Right click and drag to box select data.",
                                 bullet=True)
                    dpg.add_text(
                    ...
                    dpg.add_text(
                        ...
                        bullet=True, indent=20)
                    dpg.add_text("Double left click to fit all visible data.",
                                 bullet=True)
                    dpg.add_text(
                        "Double left click on an axis to fit the individual axis",
                        bullet=True, indent=20)
                    dpg.add_text(
                    ...
                    dpg.add_text(
                        ...
                        bullet=True)
                    dpg.add_text(
                        "IMPORTANT: By default, anti-aliased lines are turned OFF.",
                        bullet=True)
            ...
            with dpg.node_editor(
                ...
                with dpg.node(label="Node 3", pos=[25, 150]):
                    ...
                    with dpg.node_attribute(
                        ...
                        dpg.add_simple_plot(label="Node Plot",
                                            default_value=(0.3, 0.9, 2.5, 8.9),
                                            width=200, height=80,
                                            histogram=True)
            ...
            with dpg.tree_node(label="Basic"):
                ...
                with dpg.drawlist(width=300, height=200):
                    ...
                    for i in range(2):
                        ...
                        if i == 0:
                            _draw_t = 1.0
                        dpg.draw_circle([draw_x + draw_size * 0.5,
                                         draw_y + draw_size * 0.5],
                                        draw_size * 0.5, thickness=_draw_t,
                                        color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_rectangle([draw_x, draw_y],
                                           [draw_size + draw_x,
                                            draw_size + draw_y],
                                           thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_rectangle([draw_x, draw_y],
                                           [draw_size + draw_x,
                                            draw_size + draw_y],
                                           rounding=draw_rounding,
                                           thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_triangle([draw_x + draw_size * 0.5, draw_y],
                                          [draw_x + draw_size,
                                           draw_y + draw_size - 0.5],
                                          [draw_x, draw_y + draw_size - 0.5],
                                          thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_line([draw_x, draw_y],
                                      [draw_x + draw_size, draw_y],
                                      thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_line([draw_x, draw_y],
                        ...
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_line([draw_x, draw_y],
                                      [draw_x + draw_size, draw_y + draw_size],
                                      thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_bezier_quadratic(
                            [draw_x, draw_y + draw_size * 0.6],
                            [draw_x + draw_size * 0.5,
                             draw_y - draw_size * 0.4],
                            [draw_x + draw_size, draw_y + draw_size],
                            thickness=_draw_t, color=draw_color)
                        draw_x = draw_x + draw_spacing + draw_size
                        dpg.draw_bezier_cubic([draw_x, draw_y],
                                              [draw_x + draw_size * 1.3,
                                               draw_y + draw_size * 0.3],
                                              [
                                                  draw_x + draw_size - draw_size * 1.3,
                                                  draw_y + draw_size - draw_size * 0.3],
                                              [draw_x + draw_size,
                                               draw_y + draw_size],
                                              thickness=_draw_t,
                                              color=draw_color)
                    ...
                    dpg.draw_circle(
                        [draw_x + draw_size * 0.5, draw_y + draw_size * 0.5],
                        draw_size * 0.5, thickness=_draw_t, color=draw_color,
                        fill=draw_color)
                    draw_x = draw_x + draw_spacing + draw_size
                    dpg.draw_rectangle([draw_size + draw_x, draw_size + draw_y],
                                       [draw_x, draw_y], thickness=_draw_t,
                                       color=draw_color, fill=draw_color)
                    draw_x = draw_x + draw_spacing + draw_size
                    dpg.draw_rectangle([draw_x, draw_y],
                                       [draw_size + draw_x, draw_size + draw_y],
                                       rounding=draw_rounding,
                                       thickness=_draw_t, color=draw_color,
                                       fill=draw_color)
                    draw_x = draw_x + draw_spacing + draw_size
                    ...
                    draw_x = draw_x + draw_spacing + draw_size
                    dpg.draw_rectangle([draw_size + draw_x, draw_size + draw_y],
                                       [draw_x, draw_y], color=[0, 0, 0, 0],
                                       thickness=_draw_t,
                                       color_upper_left=[0, 0, 0],
                                       color_upper_right=[255, 0, 0],
                                       color_bottom_left=[255, 255, 0],
                                       color_bottom_right=[0, 255, 0],
                                       multicolor=True)
            ...
            with dpg.tree_node(label="Draw Nodes & 3D transforms"):
                ...
                with dpg.group(horizontal=True):
                                ...
                                with dpg.draw_node(tag="_drawing_planet1",
                                    ...
                                    dpg.apply_transform(dpg.last_item(),
                                                        dpg.create_rotation_matrix(
                                                            ...
                                                            [150, 0]))
                                    dpg.draw_circle([0, 0], 10,
                                                    color=[0, 255, 0],
                                                    fill=[0, 255, 0])
                                    dpg.draw_circle([0, 0], 25,
                                                    color=[255, 0, 255])
                                    with dpg.draw_node(tag="_drawing_moon1",
                                                       user_data=45.0):
                                        dpg.apply_transform(dpg.last_item(),
                                                            dpg.create_rotation_matrix(
                                                                math.pi * 45.0 / 180.0,
                                                                [0, 0,
                                                                 -1]) * dpg.create_translation_matrix(
                                                                [25, 0]))
                                        dpg.draw_circle([0, 0], 5,
                                                        color=[255, 0, 255],
                                                        fill=[255, 0, 255])

                                with dpg.draw_node(tag="_drawing_planet2",
                                                   user_data=0.0):
                                    dpg.apply_transform(dpg.last_item(),
                                                        dpg.create_rotation_matrix(
                                                            math.pi * 0.0 / 180.0,
                                    ...
                                    dpg.draw_circle([0, 0], 25,
                                                    color=[255, 0, 255])
                                    dpg.draw_circle([0, 0], 45,
                                                    color=[255, 255, 255])
                                    with dpg.draw_node(tag="_drawing_moon2",
                                                       user_data=45.0):
                                        dpg.apply_transform(dpg.last_item(),
                                                            dpg.create_rotation_matrix(
                                                                math.pi * 45.0 / 180.0,
                                    ...
                                    with dpg.draw_node(tag="_drawing_moon3",
                                                       user_data=120.0):
                                        dpg.apply_transform(dpg.last_item(),
                                                            dpg.create_rotation_matrix(
                                                                math.pi * 120.0 / 180.0,
                    ...
                    def _demo_live_drawing():
                        planet_rot1 = dpg.get_item_user_data(
                            "_drawing_planet1") + 1.0
                        planet_rot2 = dpg.get_item_user_data(
                            "_drawing_planet2") + 2.0
                        moon_rot1 = dpg.get_item_user_data(
                            "_drawing_moon1") + 3.0
                        moon_rot2 = dpg.get_item_user_data(
                            "_drawing_moon2") + 7.0
                        moon_rot3 = dpg.get_item_user_data(
                            "_drawing_moon3") + 10.0
                        dpg.apply_transform("_drawing_planet1",
                                            dpg.create_rotation_matrix(
                                                math.pi * planet_rot1 / 180.0,
                                                [0, 0,
                                                 -1]) * dpg.create_translation_matrix(
                                                [150, 0]))
                        dpg.apply_transform("_drawing_planet2",
                                            dpg.create_rotation_matrix(
                                                math.pi * planet_rot2 / 180.0,
                                                [0, 0,
                                                 -1]) * dpg.create_translation_matrix(
                                                [200, 0]))
                        dpg.apply_transform("_drawing_moon1",
                                            dpg.create_rotation_matrix(
                                                math.pi * moon_rot1 / 180.0,
                                                [0, 0,
                                                 -1]) * dpg.create_translation_matrix(
                                                [25, 0]))
                        dpg.apply_transform("_drawing_moon2",
                                            dpg.create_rotation_matrix(
                                                math.pi * moon_rot2 / 180.0,
                                                [0, 0,
                                                 -1]) * dpg.create_translation_matrix(
                                                [25, 0]))
                        dpg.apply_transform("_drawing_moon3",
                                            dpg.create_rotation_matrix(
                                                math.pi * moon_rot3 / 180.0,
                                                [0, 0,
                                                 1]) * dpg.create_translation_matrix(
                                                [45, 0]))
                    ...
                    with dpg.item_handler_registry(tag="__demo_item_reg6"):
                        dpg.add_item_visible_handler(
                            callback=_demo_live_drawing)
                    dpg.bind_item_handler_registry("_demo_advanced_drawing",
                                                   dpg.last_container())
                    ...
                    with dpg.drawlist(width=500, height=500,
                                      tag="_demo_advanced_drawing_3d"):
                        with dpg.draw_layer(depth_clipping=False,
                                            cull_mode=dpg.mvCullMode_Back,
                                            perspective_divide=True):
                            dpg.set_clip_space(dpg.last_item(), 0, 0, 500, 500,
                                               -1.0, 1.0)
                            with dpg.draw_node(tag="_demo_3dNode1",
                                               user_data=[0, 0, 0]):
                                dpg.draw_triangle(demo_verticies[1],
                                                  demo_verticies[2],
                                                  demo_verticies[0],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[0])
                                dpg.draw_triangle(demo_verticies[1],
                                                  ...
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[1])
                                dpg.draw_triangle(demo_verticies[7],
                                                  demo_verticies[5],
                                                  demo_verticies[4],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[2])
                                dpg.draw_triangle(demo_verticies[6],
                                                  demo_verticies[7],
                                                  demo_verticies[4],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[3])
                                dpg.draw_triangle(demo_verticies[9],
                                                  demo_verticies[10],
                                                  demo_verticies[8],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[4])
                                dpg.draw_triangle(demo_verticies[9],
                                                  ...
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[5])
                                dpg.draw_triangle(demo_verticies[15],
                                                  demo_verticies[13],
                                                  demo_verticies[12],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[6])
                                dpg.draw_triangle(demo_verticies[14],
                                                  demo_verticies[15],
                                                  demo_verticies[12],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[7])
                                dpg.draw_triangle(demo_verticies[18],
                                                  demo_verticies[17],
                                                  demo_verticies[16],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[8])
                                dpg.draw_triangle(demo_verticies[19],
                                                  demo_verticies[17],
                                                  demo_verticies[18],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[9])
                                dpg.draw_triangle(demo_verticies[21],
                                                  demo_verticies[23],
                                                  demo_verticies[20],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[10])
                                dpg.draw_triangle(demo_verticies[23],
                                                  demo_verticies[22],
                                                  demo_verticies[20],
                                                  color=[0, 0, 0.0],
                                                  fill=demo_colors[11])
                ...
                with dpg.group(horizontal=True):
                    with dpg.drawlist(width=500, height=500):
                        with dpg.draw_layer(depth_clipping=False,
                                            cull_mode=dpg.mvCullMode_Front,
                                            perspective_divide=True):
                            dpg.set_clip_space(dpg.last_item(), 0, 0, 500, 500,
                                               -1.0, 1.0)
                            with dpg.draw_node(tag="_demo_3dNode2",
                                               user_data=[0, 0, 0]):
                                dpg.draw_triangle(demo_verticies[1],
                                                  demo_verticies[2],
                                                  demo_verticies[0],
                    ...
                    with dpg.drawlist(width=500, height=500):
                        with dpg.draw_layer(depth_clipping=False,
                            ...
                            dpg.set_clip_space(dpg.last_item(), 0, 0, 500, 500,
                                               -1.0, 1.0)
                            with dpg.draw_node(tag="_demo_3dNode3",
                                               user_data=[0, 0, 0]):
                                dpg.draw_triangle(demo_verticies[1],
                                                  demo_verticies[2],
                                                  demo_verticies[0],
                    ...
                    def _demo_live_3D_drawing():
                        view_matrix = dpg.create_fps_matrix([0, 0, 50], 0.0,
                                                            0.0)
                        proj_matrix = dpg.create_perspective_matrix(
                            math.pi * 45.0 / 180.0, 500 / 500, 0.1, 100)
                        cube_rot = dpg.get_item_user_data("_demo_3dNode1")
                        cube_rot[0] = cube_rot[0] + 1.0
                        cube_rot[1] = cube_rot[1] + 2.0
                        cube_rot[2] = cube_rot[2] + 3.0
                        model_matrix = dpg.create_rotation_matrix(
                            math.pi * cube_rot[0] / 180.0, [1, 0, 0]) * \
                                       dpg.create_rotation_matrix(
                                           math.pi * cube_rot[1] / 180.0,
                                           [0, 1, 0]) * \
                                       dpg.create_rotation_matrix(
                                           math.pi * cube_rot[2] / 180.0,
                                           [0, 0, 1])
                        dpg.apply_transform("_demo_3dNode1",
                                            proj_matrix * view_matrix * model_matrix)
                        dpg.apply_transform("_demo_3dNode2",
                                            proj_matrix * view_matrix * model_matrix)
                        dpg.apply_transform("_demo_3dNode3",
                                            proj_matrix * view_matrix * model_matrix)
                        dpg.set_item_user_data("_demo_3dNode1", cube_rot)

                    with dpg.item_handler_registry(tag="__demo_item_reg7"):
                        dpg.add_item_visible_handler(
                            callback=_demo_live_3D_drawing)
                    dpg.bind_item_handler_registry("_demo_advanced_drawing_3d",
                                                   dpg.last_container())
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            with dpg.tree_node(label="Global"):
                ...
                with dpg.handler_registry(show=False,
                                          tag="__demo_keyboard_handler"):
                ...
                kh_down = dpg.add_text("Key id:  seconds:",
                                       label="Key Down Handler:",
                                       show_label=True)
                kh_release = dpg.add_text("Key id:",
                                          label="Key Release Handler:",
                                          show_label=True)
                kh_press = dpg.add_text("Key id:", label="Key Press Handler:",
                                        show_label=True)
                mh_click = dpg.add_text("Mouse id:",
                                        label="Mouse Click Handler",
                                        show_label=True)
                mh_double = dpg.add_text("Mouse id:",
                                         label="Mouse Double Click Handler",
                                         show_label=True)
                mh_down = dpg.add_text("Mouse id:  seconds:",
                                       label="Mouse Down Handler",
                                       show_label=True)
                mh_release = dpg.add_text("Mouse id:",
                                          label="Mouse Release Handler",
                                          show_label=True)
                mh_wheel = dpg.add_text("Mouse id:",
                                        label="Mouse Wheel Handler",
                                        show_label=True)
                mh_move = dpg.add_text("Mouse pos:", label="Mouse Move Handler",
                                       show_label=True)
                mh_drag = dpg.add_text("Mouse id:  delta:",
                                       label="Mouse Drag Handler",
                                       show_label=True)

            with dpg.tree_node(label="Item"):

                dpg.add_text(
                    "Interact with following widgets and check output!")
                dpg.add_text(
                ...
                with dpg.item_handler_registry(tag="demoitemregistry"):
                    dpg.add_item_clicked_handler(0,
                                                 callback=lambda s, a, u: print(
                                                     f"clicked_handler: {s} '\t' {a} '\t' {u}"))
                    dpg.add_item_clicked_handler(1,
                                                 callback=lambda s, a, u: print(
                                                     f"clicked_handler: {s} '\t' {a} '\t' {u}"))
            ...
            def _event_handler(sender, data):
                ...
                if type == "mvAppItemType::mvKeyDownHandler":
                    dpg.set_value(kh_down,
                                  f"Key id: {data[0]}, Seconds:{data[1]}")
                    ...
                    dpg.set_value(kh_press,
                                  f"Key id: {data} + Shift: {dpg.is_key_down(dpg.mvKey_Shift)}")
                elif type == "mvAppItemType::mvMouseClickHandler":
                    dpg.set_value(mh_click,
                                  f"Mouse id: {data} + Shift: {dpg.is_key_down(dpg.mvKey_Shift)}")
                    ...
                    dpg.set_value(mh_down,
                                  f"Mouse id: {data[0]}, Seconds:{data[1]}")
        ...
        with dpg.collapsing_header(label="Drag & Drop"):
            ...
            with dpg.tree_node(label="Help"):
                dpg.add_text(
                    "Adding a drag_payload to a widget makes it source.",
                    bullet=True)
                dpg.add_text(
                    "Adding a drop_callback to a widget makes it target.",
                    bullet=True)
                dpg.add_text(
                    "Compatibility is determined by the 'payload_type'.",
                    bullet=True)
                dpg.add_text(
                    "The 'payload_type' must be less than 32 characters.",
                    bullet=True)
                dpg.add_text(
                    "A 'drag_callback' can be used to notify a source during a DND event.",
                    bullet=True)
                dpg.add_text(
                    "A 'drag_payload' is a container. Its children are what is shown when dragging.",
                    bullet=True)
            ...
            with dpg.tree_node(label="Simple"):
                with dpg.group(horizontal=True, xoffset=200):
                    ...
                    with dpg.group():
                        ...
                        dpg.add_input_int(label="Int Target",
                                          payload_type="ints", width=100,
                                          step=0, drop_callback=lambda s,
                                                                       a: dpg.set_value(
                                s, a))
                        dpg.add_input_float(label="Float Target",
                                            payload_type="floats", width=100,
                                            step=0, drop_callback=lambda s,
                                                                         a: dpg.set_value(
                                s, a))
        ...
        with dpg.collapsing_header(label="Advanced"):
            ...
            with dpg.tree_node(label="Help (READ ME FIRST)"):
                dpg.add_text("These topics are for advanced users.",
                             bullet=True)
                dpg.add_text("Make sure you know what you are doing.",
                             bullet=True)  # Can we remove this?
            ...
            with dpg.tree_node(label="Staging"):
                ...
                dpg.add_text(
                    ...
                    bullet=True)
                dpg.add_text("Regular parent deduction rules still apply.",
                             bullet=True)
                dpg.add_text(
                    "Staging can be useful for wrapping a set of items.",
                    bullet=True)
                dpg.add_text("You can use most DPG commands on staged items.",
                             bullet=True)
                dpg.add_text("You can place any item into a stage.",
                             bullet=True)
                dpg.add_text(
                    "Items can be unstaged with 'move_item' and 'unstage'.",
                    bullet=True)
                dpg.add_text("'unstage' will also delete the stage.",
                             bullet=True)
                dpg.add_text(
                ...
                ub1 = dpg.add_button(label="Unstage buttons",
                                     callback=_unstage_items)
            ...
            with dpg.tree_node(label="Manual Mutex Control"):
                ...
                dpg.add_text(
                    "DPG has a 'rendering' thread and a 'callback' thread.",
                    bullet=True)
                dpg.add_text("Only 1 thread can hold the mutex.", bullet=True)
                dpg.add_text(
                    "The rendering thread grabs the mutex right before drawing.",
                    bullet=True)
                dpg.add_text(
                    "The callback thread grabs the mutex when you call a DPG command.",
                    bullet=True)
                dpg.add_text(
                    "If a callback calls multiple DPG commands, they will most likely execute over a few frames.",
                    bullet=True)
                dpg.add_text(
                    "To ensure multiple commands run within the same frame, you can lock/unlock the mutex manually.",
                    bullet=True)
                ...
                dpg.configure_item(b2, user_data=dpg.last_item(),
                                   callback=_callback_manual_mutex)
            ...
            if dpg.get_platform() == dpg.mvPlatform_Windows or dpg.get_platform() == dpg.mvPlatform_Linux:
                with dpg.tree_node(label="Output Framebuffer"):
                    def _framebuffer_callback(sender, app_data):
                        ...
                        dpg.add_dynamic_texture(app_data.get_width(),
                                                app_data.get_height(), app_data,
                                                parent="__demo_texture_container")

                    dpg.add_text(
                        "Outputs frame buffer an mvBuffer object, creates a dynamic texture, and shows the texture registry (check final item)")
                    dpg.add_button(label="Output Framebuffer",
                                   callback=lambda: dpg.output_frame_buffer(
                                       callback=_framebuffer_callback))
