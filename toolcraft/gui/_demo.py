            ...
            with dpg.table_row():
                for j in range(columns):
                    dpg.add_checkbox(
                        ...
                        callback=_config,
                        user_data=item,
                        default_value=dpg.get_item_configuration(item)[names[
                            i * columns + j]],
                    )
    ...
    with dpg.window(
        ...
        with dpg.collapsing_header(label="Widgets"):
            ...
            with dpg.tree_node(label="Basic"):
                    ...
                    for i in range(7):
                        with dpg.theme(tag="__demo_theme" + str(i)):
                            with dpg.theme_component(dpg.mvButton):
                                ...
                                dpg.add_theme_style(
                                    dpg.mvStyleVar_FramePadding, i * 3, i * 3)
                ...
                dpg.add_input_float(label="input float",
                                    callback=_log,
                                    format="%.06f")
                dpg.add_input_float(label="input float scientific",
                                    format="%e",
                                    callback=_log)
                dpg.add_input_floatx(label="input floatx",
                                     callback=_log,
                                     default_value=[1, 2, 3, 4])
                dpg.add_input_double(label="input double",
                                     callback=_log,
                                     format="%.14f")
                ...
                dpg.add_slider_int(label="slider int",
                                   max_value=3,
                                   callback=_log)
            ...
            with dpg.tree_node(label="Color Picker & Edit"):
                ...
                with dpg.group(horizontal=True):
                    ...
                    dpg.add_radio_button(
                        ("mvColorEdit_rgb", "mvColorEdit_hsv",
                         "mvColorEdit_hex"),
                        callback=_color_picker_configs,
                        user_data=_color_edit_id,
                        horizontal=True,
            ...
            with dpg.tree_node(label="Text Input"):
                ...
                with dpg.tree_node(label="Multi-line Text Input"):
                    ...
                    _add_config_options(dpg.last_item(), 1, "readonly",
                                        "on_enter")
            ...
            with dpg.tree_node(label="Simple Plots"):
                ...
                dpg.add_simple_plot(label="Lines",
                                    default_value=data1,
                                    height=80)
        ...
        with dpg.collapsing_header(label="Layout & Scrolling"):
            ...
            with dpg.tree_node(label="Grid Layout using Table API"):
                ...
                dpg.add_checkbox(label="resizable",
                                 callback=_config,
            ...
            with dpg.tree_node(label="Containers"):
                ...
                with dpg.tree_node(label="Child windows"):
                    ...
                    with dpg.child_window(tag=demo_layout_child,
                                          width=200,
                                          height=200):
                        with dpg.menu_bar():
                            with dpg.menu(label="Menu"):
                ...
                with dpg.tree_node(label="Collapsing Headers"):
                    ...
                    with dpg.collapsing_header(
                        ...
                        dpg.add_button(label="Button 3")
                    with dpg.collapsing_header(
                            label="Collapsing Header (leaf)", leaf=True):
                        dpg.add_button(label="Button 1")
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
        ...
        with dpg.collapsing_header(label="Textures & Images"):
            ...
            with dpg.tree_node(label="Help"):
                ...
                dpg.add_text("Textures are buffers of RGBA data.",
                             ...
                             indent=20)
                dpg.add_text(
                    "Textures are used by 'image based' widgets:",
                    bullet=True,
                    indent=20,
                )
            ...
            with dpg.tree_node(label="Dynamic Textures"):
                ...
                dpg.add_text(
                    "Can be modified after creation with 'set_value'.",
                    bullet=True,
                    indent=20,
                )
                dpg.add_text(
            ...
            with dpg.tree_node(label="Image Series (plots)"):
                with dpg.plot(label="Image Plot", height=400, width=-1):
                    ...
                    with dpg.plot_axis(dpg.mvYAxis, label="y axis"):
                        ...
                        dpg.add_image_series(
                            "__demo_static_texture_2",
                            [150, 150],
                            [200, 200],
                            label="static 2",
                        )
                        dpg.add_image_series(
                            "__demo_static_texture_3",
                            [200, -150],
                            [300, -50],
                            label="static 3",
                        )
                        dpg.add_image_series(
                            "__demo_dynamic_texture_1",
                            [-200, 100],
                            [-100, 200],
                            label="dynamic 1",
                        )
                        dpg.add_image_series(
                            "__demo_dynamic_texture_2",
                            [-200, -100],
                            [-150, -50],
                            label="dynamic 2",
                        )
        ...
        with dpg.collapsing_header(label="Tables"):
            ...
            with dpg.tree_node(label="Resizable, mixed"):
                ...
                with dpg.table(
                    ...
                    dpg.add_table_column(label="CCC",
                                         width_stretch=True,
                ...
                with dpg.table(
                    ...
                    dpg.add_table_column(label="CCC",
                                         width_stretch=True,
                                         init_width_or_weight=0.0)
                    dpg.add_table_column(label="DDD",
                                         width_stretch=True,
                                         init_width_or_weight=0.0)
            ...
            with dpg.tree_node(label="Scrolling, Clipping"):
                ...
                dpg.add_checkbox(
                    ...
                    configure_item(user_data, resizable=app_data),
                )
            ...
            with dpg.tree_node(label="Sorting"):
                ...
                dpg.add_checkbox(
                    ...
                    callback=lambda sender, app_data, user_data: dpg.
                    configure_item("__demo_sorting_table",
            ...
            with dpg.tree_node(label="Sizing Policy"):
                ...
                def callback(sender, value, user_data):
                    ...
                    if user_data[8] == "resizable":
                        ...
                        if value == "mvTable_SizingFixedFit":
                            dpg.configure_item(
                                user_data[user_data[9]],
                                policy=dpg.mvTable_SizingFixedFit,
                            )
                            dpg.configure_item(
                                user_data[user_data[9] + 1],
                                policy=dpg.mvTable_SizingFixedFit,
                            )
                ...
                dpg.add_combo(
                    sizing_options,
                    label="Sizing Policy",
                    default_value=sizing_options[1],
                    before=table_id2,
                ...
                dpg.add_combo(
                    sizing_options,
                    label="Sizing Policy",
                    default_value=sizing_options[2],
                    before=table_id3,
                ...
                dpg.add_combo(
                    sizing_options,
                    label="Sizing Policy",
                    default_value=sizing_options[3],
                    before=table_id4,
            ...
            with dpg.tab_bar():
                ...
                with dpg.tab(label="Series"):
                    ...
                    with dpg.tree_node(label="Shade Series"):
                        ...
                        with dpg.plot(label="Stock Prices",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            ...
                            with dpg.plot_axis(dpg.mvYAxis, label="Price"):
                                dpg.add_line_series(stock_datax,
                                                    stock_data1,
                                                    label="Stock 1")
                                dpg.bind_item_theme(dpg.last_item(),
                                                    "stock_theme1")
                    ...
                    with dpg.tree_node(label="Scatter Series"):
                        with dpg.plot(label="Scatter Series",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            dpg.add_plot_axis(dpg.mvXAxis, label="x")
                    ...
                    with dpg.tree_node(label="Infinite Lines"):
                        ...
                        with dpg.plot(label="Infinite Lines",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis, label="x")
                    ...
                    with dpg.tree_node(label="Candle Stick Series"):
                        ...
                        with dpg.plot(label="Candle Series",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis,
                    ...
                    with dpg.tree_node(label="Error Series"):
                        ...
                        with dpg.plot(label="Error Series",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            with dpg.plot_axis(dpg.mvYAxis, label="y"):
                                dpg.add_bar_series(error1_x,
                                                   error1_y,
                                                   label="Bar",
                                                   weight=0.25)
                ...
                with dpg.tab(label="Subplots"):
                    ...
                    with dpg.tree_node(label="Basic"):
                        ...
                        _add_config_options(subplot_id,
                                            1,
                                            "no_resize",
                                            "no_title",
                                            before=subplot_id)
                ...
                with dpg.tab(label="Axes"):
                    ...
                    with dpg.tree_node(label="Multi Axes Plot"):
                        with dpg.plot(label="Multi Axes Plot",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                ...
                with dpg.tab(label="Tools"):
                    ...
                    with dpg.tree_node(label="Drag Lines/Points"):
                        with dpg.plot(label="Drag Lines/Points",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            dpg.add_plot_axis(dpg.mvXAxis, label="x")
                ...
                with dpg.tab(label="Custom"):
                    ...
                    with dpg.tree_node(label="Custom Rendering"):
                        ...
                        # create plot
                        with dpg.plot(label="Custom Rendering",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_axis(dpg.mvXAxis, label="x")
                            dpg.add_plot_axis(dpg.mvYAxis, label="y")
                    ...
                    with dpg.tree_node(label="Custom Series"):
                        ...
                        def _custom_series_callback(sender, app_data):
                            ...
                            for i in range(0, len(transformed_x)):
                                ...
                                if (mouse_x_pixel_space < transformed_x[i] + 15
                                        and mouse_x_pixel_space >
                                        transformed_x[i] - 15
                                        and mouse_y_pixel_space >
                                        transformed_y[i] - 15
                                        and mouse_y_pixel_space <
                                        transformed_y[i] + 15):
                                    dpg.draw_circle(
                        ...
                        with dpg.plot(label="Custom Series",
                                      height=400,
                                      width=-1):
                            dpg.add_plot_legend()
                            xaxis = dpg.add_plot_axis(dpg.mvXAxis)
                ...
                with dpg.group(horizontal=True):
                    ...
                    def _demo_live_drawing():
                        ...
                        dpg.apply_transform(
                            "_drawing_planet1",
                            dpg.create_rotation_matrix(
                                math.pi * planet_rot1 / 180.0, [0, 0, -1]) *
                            dpg.create_translation_matrix([150, 0]),
                        )
                        dpg.apply_transform(
                            "_drawing_planet2",
                            dpg.create_rotation_matrix(
                                math.pi * planet_rot2 / 180.0, [0, 0, -1]) *
                            dpg.create_translation_matrix([200, 0]),
                        )
                        dpg.apply_transform(
                            "_drawing_moon1",
                            dpg.create_rotation_matrix(
                                math.pi * moon_rot1 / 180.0, [0, 0, -1]) *
                            dpg.create_translation_matrix([25, 0]),
                        )
                        dpg.apply_transform(
                            "_drawing_moon2",
                            dpg.create_rotation_matrix(
                                math.pi * moon_rot2 / 180.0, [0, 0, -1]) *
                            dpg.create_translation_matrix([25, 0]),
                        )
                        dpg.apply_transform(
                            "_drawing_moon3",
                            dpg.create_rotation_matrix(
                                math.pi * moon_rot3 / 180.0, [0, 0, 1]) *
                            dpg.create_translation_matrix([45, 0]),
                        )
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            with dpg.tree_node(label="Global"):
                ...
                dpg.add_checkbox(
                    label="Activate Keyboard Handlers (A key)",
                    callback=lambda s, a: dpg.configure_item(
                        "__demo_keyboard_handler", show=a),
                )
                dpg.add_checkbox(
                    label="Activate Mouse Handlers (left button)",
                    callback=lambda s, a: dpg.configure_item(
                ...
                kh_release = dpg.add_text("Key id:",
                                          ...
                                          show_label=True)
                kh_press = dpg.add_text("Key id:",
                                        label="Key Press Handler:",
                                        show_label=True)
                ...
                mh_wheel = dpg.add_text("Mouse id:",
                                        ...
                                        show_label=True)
                mh_move = dpg.add_text("Mouse pos:",
                                       label="Mouse Move Handler",
                                       show_label=True)
        ...
        with dpg.collapsing_header(label="Advanced"):
            ...
            with dpg.tree_node(label="Manual Mutex Control"):
                ...
                def _callback_manual_mutex(sender, app_data, user_data):
                    ...
                    dpg.push_container_stack(
                        dpg.add_stage(id=staged_container))
                    for i in range(100):
