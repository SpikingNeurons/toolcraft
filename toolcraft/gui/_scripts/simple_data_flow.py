"""
https://github.com/hoffstadt/SimpleDataFlow/edit/main/simple_data_flow.py
"""
...
with dpg.theme() as _completion_theme:
    ...
    dpg.add_theme_color(dpg.mvNodeCol_TitleBarHovered, [37, 28, 138],
                        category=dpg.mvThemeCat_Nodes)
    dpg.add_theme_color(dpg.mvNodeCol_TitleBarSelected, [37, 28, 138],
                        category=dpg.mvThemeCat_Nodes)
...
class CheckerNode(Node):
    ...
    def custom(self):
        ...
        with dpg.group(width=150):
            dpg.add_input_float(label="Expected Value",
                                step=0.0,
                                id=self.expected_id,
                                default_value=10)
            dpg.add_input_float(label="Max Tolerance",
                                step=0.0,
                                id=self.max_id,
                                default_value=0.05)
            dpg.add_input_float(label="Min Tolerance",
                                step=0.0,
                                id=self.min_id,
                                default_value=0.05)
