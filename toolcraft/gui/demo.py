        ...
        if 'before' in kwargs:
            ...
            with dpg.table(header_row=False, before=kwargs['before']):
                ...
                for i in range(0, len(names) - 1):
                    dpg.add_checkbox(label=names[i], callback=_config,
                                     user_data=item, default_value=
                                     dpg.get_item_configuration(item)[names[i]])
                    dpg.add_table_next_column()
                dpg.add_checkbox(label=names[-1], callback=_config,
                                 user_data=item,
                                 default_value=dpg.get_item_configuration(item)[
                                     names[-1]])
    ...
    with dpg.window(label="Dear PyGui Demo", width=800, height=800,
        ...
        with dpg.menu_bar():
            ...
            with dpg.menu(label="File"):
                ...
                with dpg.menu(label="Settings"):
                    ...
                    with dpg.child(height=60, autosize_x=True,
                                   delay_search=True):
                        for i in range(0, 10):
            ...
            with dpg.menu(label="Tools"):
                ...
                dpg.add_menu_item(label="Show ImPlot Demo",
                                  callback=lambda: dpg.show_implot_demo())
            ...
            with dpg.tree_node(label="Basic"):
                ...
                with dpg.group(horizontal=True):
                    dpg.add_button(label="Button", callback=_log,
                                   user_data=logger)
                    dpg.add_button(label="Button", callback=_log,
                                   user_data=logger, small=True)
                    dpg.add_button(label="Button", callback=_log,
                                   user_data=logger,
                                   arrow=True)  # default direction is mvDir_Up
                    dpg.add_button(label="Button", callback=_log,
                                   user_data=logger, arrow=True,
        ...
        with dpg.collapsing_header(label="Layout & Scrolling"):
            ...
            with dpg.tree_node(label="Containers"):
                ...
                with dpg.tree_node(label="Child windows"):
                    ...
                    with dpg.child(autosize_x=True, height=130, menubar=True):
                        ...
                        dpg.add_button(label="Button 2")
                        dpg.add_button(label="Button 3")
                    with dpg.child(width=100, height=150,
            ...
            with dpg.tree_node(label="Scrolling"):
                ...
                for i in range(0, 5):
                    dpg.add_text(text_items[i])
                    with dpg.child(height=50, horizontal_scrollbar=True,
                                   width=-200, delay_search=True):
                        for j in range(0, 25):
                            if j == 13:
                                dpg.add_text("Item " + str(j),
        ...
        with dpg.collapsing_header(label="Textures & Images"):
            ...
            with dpg.tree_node(label="Static Textures"):
                ...
                with dpg.group(horizontal=True):
                    ...
                    with dpg.group():
                        ...
                        dpg.add_image(demo_static_texture_3, width=200,
                                      height=200)
            ...
            with dpg.tree_node(label="Dynamic Textures"):
                ...
                with dpg.group():
                    dpg.add_color_picker((255, 0, 255, 255), label="Texture 1",
                                         ...
                                         user_data=1)
                    dpg.add_text("Image Button")
                    dpg.add_image_button(demo_dynamic_texture_1, width=100,
                                         height=100)
            ...
            with dpg.tree_node(label="Drawlists"):
                with dpg.drawlist(width=400, height=300):
                    ...
                    dpg.draw_image(demo_dynamic_texture_1, [200, 100],
                                   [300, 200])
                ...
                with dpg.popup(b):
                    ...
                    dpg.add_selectable(label="Bream", user_data=[t, "Bream"],
                                       callback=lambda s, a, u: dpg.set_value(
                                           u[0], u[1]))
                    dpg.add_selectable(label="Haddock",
                                       user_data=[t, "Haddock"],
                                       callback=lambda s, a, u: dpg.set_value(
                                           u[0], u[1]))
                    dpg.add_selectable(label="Mackerel",
                                       user_data=[t, "Mackerel"],
                                       callback=lambda s, a, u: dpg.set_value(
                                           u[0], u[1]))
                    dpg.add_selectable(label="Pollock",
                                       user_data=[t, "Pollock"],
                                       callback=lambda s, a, u: dpg.set_value(
                                           u[0], u[1]))
                    dpg.add_selectable(label="Tilefish",
                                       user_data=[t, "Tilefish"],
                                       callback=lambda s, a, u: dpg.set_value(
                                           u[0], u[1]))
        ...
        with dpg.collapsing_header(label="Tables"):
            ...
            with dpg.tree_node(label="Borders, background") as section:
                ...
                _add_config_options(dpg.last_container(), 2,
                                    ...
                                    "header_row", before=dpg.last_container())
            ...
            with dpg.tree_node(label="Resizable, stretch"):
                ...
                _add_config_options(dpg.last_container(), 1,
                                    ...
                                    "resizable", before=dpg.last_container())
                ...
                with dpg.tab(label="Series"):
                    ...
                    with dpg.tree_node(label="Bar Series"):
                        with dpg.plot(label="Bar Series", height=400, width=-1):
                            ...
                            # create y axis
                            yaxis_id = dpg.add_plot_axis(dpg.mvYAxis,
                                                         label="Score")
                    ...
                    with dpg.tree_node(label="Image Series"):
                        with dpg.plot(label="Image Plot", height=400, width=-1):
                            ...
                            dpg.add_image_series(2, [300, 300], [400, 400],
                                                 label="font atlas",
                                                 parent=yaxis_id)
                            dpg.add_image_series(demo_static_texture_2,
                                                 [150, 150], [200, 200],
                                                 label="static 2",
                                                 parent=yaxis_id)
                            dpg.add_image_series(demo_dynamic_texture_1,
                                                 [-200, 100], [-100, 200],
                                                 label="dynamic 1",
                                                 parent=yaxis_id)
                            dpg.fit_axis_data(xaxis)
                    ...
                    with dpg.tree_node(label="Candle Stick Series"):
                        ...
                        with dpg.plot(label="Candle Series", height=400,
                            ...
                            dpg.add_candle_series(dates, opens, closes, lows,
                                                  highs, label="GOOGL",
                                                  parent=dpg.last_item())
        ...
        with dpg.collapsing_header(label="Drawing API"):
            ...
            with dpg.group(width=200) as inputs:
                ...
                dpg.add_button(label="Clear Layer",
                               callback=lambda: dpg.delete_item(
                                   layers[dpg.get_value(layer)],
                                   children_only=True))
                drawables = dpg.add_listbox(label="Draw Item",
                                            default_value="Line", width=100,
                                            num_items=5, callback=_switch_group)

                with dpg.group(width=200) as line:
                    draw_groups["line"] = line
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="p1", size=2,
                                            default_value=(10, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="p2", size=2,
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_line, r, k, layer,
                                              False])

                with dpg.group(width=200, show=False) as circle:
                    draw_groups["circle"] = circle
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="center", size=2,
                                            default_value=(100, 100),
                                            max_value=800)
                        dpg.add_slider_int(label="radius", default_value=20,
                                           max_value=100)
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_circle, r, k, layer,
                                              False])

                with dpg.group(width=200, show=False) as ellipse:
                    draw_groups["ellipse"] = ellipse
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="pmin", size=2,
                                            default_value=(50, 50),
                                            max_value=800)
                        dpg.add_slider_intx(label="pmax", size=2,
                                            default_value=(60, 70),
                                            max_value=800)
                    with dpg.group() as k:
                        dpg.add_slider_int(label="thickness", default_value=1)
                        ...
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_ellipse, r, k, layer,
                                              False])
                ...
                with dpg.group(width=200, show=False) as arrow:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_arrow, r, k, layer,
                                              False])
                ...
                with dpg.group(width=200, show=False) as bezier_cubic:
                    ...
                    with dpg.group() as r:
                        ...
                        dpg.add_slider_intx(label="p2", size=2,
                                            default_value=(50, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="p3", size=2,
                                            default_value=(10, 40),
                                            max_value=800)
                        dpg.add_slider_intx(label="p4", size=2,
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_bezier_cubic, r, k,
                                              layer, False])
                ...
                with dpg.group(width=200, show=False) as bezier_quadratic:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_bezier_quadratic, r, k,
                                              layer, False])

                with dpg.group(width=200, show=False) as polygon:
                    draw_groups["polygon"] = polygon
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="point 1", size=2,
                                            default_value=(10, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="point 2", size=2,
                                            default_value=(50, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="point 3", size=2,
                                            default_value=(50, 40),
                                            max_value=800)
                        dpg.add_slider_intx(label="point 4", size=2,
                                            default_value=(30, 60),
                                            max_value=800)
                        dpg.add_slider_intx(label="point 5", size=2,
                                            default_value=(10, 10),
                                            max_value=800)
                    with dpg.group() as k:
                        dpg.add_input_int(label="thickness", default_value=1)
                        ...
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_polygon, r, k, layer,
                                              True])
                ...
                with dpg.group(width=200, show=False) as polyline:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_polyline, r, k, layer,
                                              True])
                ...
                with dpg.group(width=200, show=False) as quad:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_quad, r, k, layer,
                                              False])
                ...
                with dpg.group(width=200, show=False) as rectangle:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_rectangle, r, k, layer,
                                              False])
                ...
                with dpg.group(width=200, show=False) as triangle:
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((0, 0, 0, 0), label="fill",
                                             alpha_bar=True)
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_triangle, r, k, layer,
                                              False])

                with dpg.group(width=200, show=False) as text:
                    draw_groups["text"] = text
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="pos", size=2,
                                            default_value=(70, 50),
                                            max_value=800)
                    ...
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_text, r, k, layer,
                                              False])
                ...
                with dpg.group(width=200, show=False) as image:
                    ...
                    with dpg.group() as r:
                        ...
                        dpg.add_slider_intx(label="pmin", size=2,
                                            ...
                                            max_value=800)
                        dpg.add_slider_intx(label="pmax", size=2,
                                            default_value=(300, 300),
                                            max_value=800)
                    with dpg.group() as k:
                        dpg.add_slider_floatx(label="uv_min", size=2,
                                              default_value=(0.0, 0.0),
                                              max_value=2.0, min_value=-1.0)
                        dpg.add_slider_floatx(label="uv_max", size=2,
                                              default_value=(1.0, 1.0),
                                              max_value=2.0, min_value=-1.0)
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                    dpg.add_button(label="Add", callback=_draw,
                                   user_data=[dpg.draw_image, r, k, layer,
                                              False])
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            key_constants = {"All": -1, "dpg.mvKey_Shift": dpg.mvKey_Shift,
                             "dpg.mvKey_0": dpg.mvKey_0,
                             "dpg.mvKey_A": dpg.mvKey_A}
            ...
            with dpg.tree_node(label="Keyboard"):
                ...
                dpg.add_combo(list(key_constants.keys()), label="key",
                              ...
                              user_data=(
                              key_constants, [k_down, k_release, k_press]))
            ...
            with dpg.tree_node(label="Mouse"):
                ...
                dpg.add_combo(list(mouse_constants.keys()), label="button",
                              default_value="All", callback=_set_activator,
                              user_data=(mouse_constants,
                                         [m_click, m_double_click, m_release,
                                          m_drag, m_down]))
            ...
            with dpg.tree_node(label="Simple"):
                ...
                with dpg.group():
                    ...
                    dpg.add_input_int(label="Int Target", payload_type="ints",
                                      width=100, step=0,
                                      drop_callback=lambda s, a: dpg.set_value(
                                          s, a))
        ...
        with dpg.collapsing_header(label="Advanced"):
            ...
            with dpg.tree_node(label="Staging"):
                ...
                dpg.add_text(
                    "Staging can be used to create items without parents.",
                    bullet=True)
                dpg.add_text(
                    "Regular parent deduction rules still apply (but will stage if parent can't be deduced).",
                    bullet=True)
                dpg.add_text("Staging is toggled with 'set_staging_mode'.",
                             bullet=True)
                dpg.add_text(
