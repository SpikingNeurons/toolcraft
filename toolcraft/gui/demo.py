        ...
        if "before" in kwargs:
            ...
            with dpg.table(header_row=False, before=kwargs["before"]):
                ...
                dpg.add_checkbox(
                    ...
                    callback=_config,
                    user_data=item,
                    default_value=dpg.get_item_configuration(item)[names[-1]],
                )
    ...
    with dpg.window(
            ...
            with dpg.menu(label="Themes"):
                ...
                dpg.add_menu_item(
                    ...
                    callback=lambda: dpg.set_item_theme(
                        demo_id, DARK_IMGUI_THEME),
                )
                dpg.add_menu_item(
                    label="Light ImGui",
                    callback=lambda: dpg.set_item_theme(
                        demo_id, LIGHT_IMGUI_THEME),
                )
        ...
        with dpg.collapsing_header(label="Widgets"):
            ...
            with dpg.tree_node(label="Color Picker & Edit"):
                ...
                dpg.add_color_edit((255, 0, 255, 255),
                                   label="Color Edit",
                                   width=200,
                                   id=_color_edit_id)
        ...
        with dpg.collapsing_header(label="Textures & Images"):
            ...
            with dpg.tree_node(label="Help"):
                ...
                dpg.add_button(
                    label="Press Here",
                    small=True,
                    callback=lambda: dpg.configure_item(demo_texture_container,
                                                        show=True),
                )
                dpg.add_separator()
        ...
        with dpg.collapsing_header(label="Tables"):
            ...
            with dpg.tree_node(label="Sorting"):
                ...
                def sort_callback(sender, app_data, user_data):
                    ...
                    if app_data[0][0] == dpg.get_item_info(
                            sender)["children"][0][0]:
                        oldList.sort(key=col1_sorter, reverse=reverse)
                    elif app_data[0][0] == dpg.get_item_info(
                            sender)["children"][0][1]:
                ...
                dpg.add_checkbox(
                    ...
                    user_data=table_id,
                    callback=lambda sender, app_data, user_data: dpg.
                    configure_item(user_data, sort_multi=app_data),
                )
                dpg.add_checkbox(
                    label="sort_tristate",
                    before=table_id,
                    user_data=table_id,
                    callback=lambda sender, app_data, user_data: dpg.
                    configure_item(user_data, sort_tristate=app_data),
                )
            ...
            with dpg.group(width=200) as inputs:
                ...
                dpg.add_button(
                    ...
                    callback=lambda: dpg.delete_item(
                        layers[dpg.get_value(layer)], children_only=True),
                )
                drawables = dpg.add_listbox(
                    label="Draw Item",
                    default_value="Line",
                    width=100,
                    num_items=5,
                ...
                with dpg.group(width=200) as line:
                    ...
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="p1",
                                            size=2,
                                            default_value=(10, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="p2",
                                            size=2,
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_line, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as circle:
                    ...
                    with dpg.group() as r:
                        ...
                        dpg.add_slider_int(label="radius",
                                           default_value=20,
                                           max_value=100)
                    with dpg.group() as k:
                        ...
                        dpg.add_color_picker((255, 255, 255, 255),
                                             label="color")
                        dpg.add_color_picker((0, 0, 0, 0),
                                             label="fill",
                                             alpha_bar=True)
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_circle, r, k, layer, False],
                    )

                with dpg.group(width=200, show=False) as ellipse:
                    draw_groups["ellipse"] = ellipse
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="pmin",
                                            size=2,
                                            default_value=(50, 50),
                                            max_value=800)
                        dpg.add_slider_intx(label="pmax",
                                            size=2,
                                            default_value=(60, 70),
                                            max_value=800)
                    with dpg.group() as k:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_ellipse, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as arrow:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_arrow, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as bezier_cubic:
                    ...
                    with dpg.group() as r:
                        ...
                        dpg.add_slider_intx(label="p2",
                                            ...
                                            default_value=(50, 10),
                                            max_value=800)
                        dpg.add_slider_intx(label="p3",
                                            size=2,
                                            default_value=(10, 40),
                                            max_value=800)
                        dpg.add_slider_intx(label="p4",
                                            size=2,
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_bezier_cubic, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as bezier_quadratic:
                    ...
                    dpg.add_button(
                        ...
                        callback=_draw,
                        user_data=[
                            dpg.draw_bezier_quadratic, r, k, layer, False
                        ],
                    )
                ...
                with dpg.group(width=200, show=False) as polygon:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_polygon, r, k, layer, True],
                    )
                ...
                with dpg.group(width=200, show=False) as polyline:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_polyline, r, k, layer, True],
                    )
                ...
                with dpg.group(width=200, show=False) as quad:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_quad, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as rectangle:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_rectangle, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as triangle:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_triangle, r, k, layer, False],
                    )

                with dpg.group(width=200, show=False) as text:
                    draw_groups["text"] = text
                    with dpg.group() as r:
                        dpg.add_slider_intx(label="pos",
                                            size=2,
                                            default_value=(70, 50),
                                            max_value=800)
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_text, r, k, layer, False],
                    )
                ...
                with dpg.group(width=200, show=False) as image:
                    ...
                    dpg.add_button(
                        label="Add",
                        callback=_draw,
                        user_data=[dpg.draw_image, r, k, layer, False],
                    )
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            key_constants = {
                "All": -1,
                "dpg.mvKey_Shift": dpg.mvKey_Shift,
            ...
            with dpg.tree_node(label="Keyboard"):
                ...
                dpg.add_combo(
                    list(key_constants.keys()),
                    label="key",
                    default_value="All",
                    callback=_set_activator,
