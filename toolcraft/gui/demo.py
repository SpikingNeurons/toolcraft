    ...
    with dpg.window(
        ...
        with dpg.collapsing_header(label="Textures & Images"):
            ...
            with dpg.tree_node(label="Help"):
                ...
                dpg.add_text(
                    "Textures are buffers of RGBA data.",
                    bullet=True,
                    indent=20,
                )
                dpg.add_text(
                ...
                dpg.add_text(
                    "Textures are themselves widgets.",
                    bullet=True,
                    indent=20,
                )
                dpg.add_text(
            ...
            with dpg.tab_bar():
                ...
                with dpg.tab(label="Custom"):
                    ...
                    with dpg.tree_node(label="Custom Context Menus"):
                        dpg.add_text(
                            "Right-click the series in the legend.",
                            bullet=True,
                        )
                        dpg.add_text(
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            with dpg.tree_node(label="Keyboard"):
                ...
                kh_release = dpg.add_text(
                    "key id:",
                    label="Key Release Handler:",
                    show_label=True,
                )
                kh_press = dpg.add_text(
                    "key id:",
            ...
            with dpg.tree_node(label="Mouse"):
                ...
                mh_release = dpg.add_text(
                    "mouse id:",
                    label="Mouse Release Handler",
                    show_label=True,
                )
                mh_wheel = dpg.add_text(
                    "mouse id:",
                    label="Mouse Wheel Handler",
                    show_label=True,
                )
                mh_move = dpg.add_text(
                    "mouse pos:",
        ...
        with dpg.collapsing_header(label="Advanced"):
            ...
            with dpg.tree_node(label="Staging"):
                ...
                dpg.add_text(
                    "Staging is toggled with 'set_staging_mode'.",
                    bullet=True,
                )
                dpg.add_text(
                ...
                dpg.add_text(
                    "You can use most DPG commands on staged items.",
                    bullet=True,
                )
