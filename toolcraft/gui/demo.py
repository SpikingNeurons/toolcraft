                ...
                for i in range(2, 5):
                    with dpg.group():
                        ...
                        dpg.add_slider_floatx(
                            label=f"slider float {i}",
                            source=float_source,
                            size=i,
                        )

                    with dpg.group():
                        int_source = dpg.add_input_intx(
                            label=f"input int {i}",
                            min_value=0,
                            max_value=100,
                            size=i,
        ...
        with dpg.collapsing_header(label="Inputs & Events"):
            ...
            with dpg.tree_node(label="Mouse"):
                ...
                mh_click = dpg.add_text("mouse id:",
                                        ...
                                        show_label=True)
                mh_double = dpg.add_text(
                    "mouse id:",
                    label="Mouse Double Click Handler",
                    show_label=True,
                )
                mh_down = dpg.add_text(
                    "mouse id:  seconds:",
