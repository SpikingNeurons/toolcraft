...
@dataclasses.dataclass
class ColormapRegistry(Container):
    """
    Refer:
...
@dataclasses.dataclass
class ItemHandlerRegistry(Container):
    """
    Refer:
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.item_handler_registry(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class NodeEditor(Container):
    ...
    delink_callback: Callback = None

    # menubar (bool, optional): Shows or hides the menubar.
    menubar: bool = False

    def build(self) -> t.Union[int, str]:
        _ret = dpg.node_editor(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
            ...
            tracked=self.tracked,
            track_offset=self.track_offset,
            delink_callback=self.delink_callback_fn,
            menubar=self.menubar,
        )
    ...
    def delink_callback_fn(
        ...
        if self.delink_callback is None:
            ...
            return self.delink_callback.fn(
                sender=self, app_data=app_data, user_data=user_data
            )
...
@dataclasses.dataclass
class TemplateRegistry(Container):
    """
    Refer:
...
class HistogramSeries2D(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_2d_histogram_series(
            **self.internal.dpg_kwargs,
            x=self.x,
            y=self.y,
            label=self.label,
...
class ItemActivatedHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_activated_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemActiveHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_active_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemClickedHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_clicked_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
            label=self.label,
            user_data=self.user_data,
...
class ItemDeactivatedAfterEditHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_deactivated_after_edit_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemDeactivatedHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_deactivated_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemEditedHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_edited_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemFocusHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_focus_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemHoverHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_hover_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemResizeHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_resize_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemToggledOpenHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_toggled_open_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class ItemVisibleHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_item_visible_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class KeyPressHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_key_press_handler(
            **self.internal.dpg_kwargs,
            key=self.key,
            label=self.label,
            user_data=self.user_data,
...
class KeyReleaseHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_key_release_handler(
            **self.internal.dpg_kwargs,
            key=self.key,
            label=self.label,
            user_data=self.user_data,
...
class LoadingIndicator(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_loading_indicator(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class MouseClickHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_click_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
            label=self.label,
            user_data=self.user_data,
...
class MouseDoubleClickHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_double_click_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
            label=self.label,
            user_data=self.user_data,
...
class MouseDownHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_down_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
            label=self.label,
            user_data=self.user_data,
...
class MouseDragHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_drag_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
...
class MouseMoveHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_move_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class MouseReleaseHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_release_handler(
            **self.internal.dpg_kwargs,
            button=self.button,
            label=self.label,
            user_data=self.user_data,
...
class MouseWheelHandler(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.add_mouse_wheel_handler(
            **self.internal.dpg_kwargs,
            label=self.label,
            user_data=self.user_data,
            use_internal_label=self.use_internal_label,
...
class DrawBezierQuadratic(Widget):
    ...
    def build(self) -> t.Union[int, str]:
        _ret = dpg.draw_bezier_quadratic(
            **self.internal.dpg_kwargs,
            p1=self.p1,
            p2=self.p2,
            p3=self.p3,
